...
*PaymentsApi* | [**GenerateBulkCRN**](docs/PaymentsApi.md#generatebulkcrn) | **POST** /api/v3/partner/firms/{firm_id}/bpay/bulk | Generate bulk BPAY CRN numbers. Used in AU only
*PaymentsApi* | [**GenerateCRN**](docs/PaymentsApi.md#generatecrn) | **POST** /api/v3/partner/firms/{firm_id}/bpay | Generate a BPAY CRN number. Used in AU only
...
## Documentation for Models
 ...
 - [Model.BpayBulkResponse](docs/BpayBulkResponse.md)
 - [Model.BpayMapping](docs/BpayMapping.md)
 - [Model.BpayResponse](docs/BpayResponse.md)
 ...
 - [Model.MatterBankDepositSyncEvent](docs/MatterBankDepositSyncEvent.md)
 - [Model.MatterBankDepositSyncEventAllOf](docs/MatterBankDepositSyncEventAllOf.md)
 - [Model.MatterReceiptSyncEvent](docs/MatterReceiptSyncEvent.md)
