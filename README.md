...
*AuthApi* | [**RetrieveFirmAPIKey**](docs/AuthApi.md#retrievefirmapikey) | **POST** /api/v3/partner/firms/{firm_id}/auth | Retrieve the details of a firm's API key
*BankAccountApi* | [**CreateFirmBankAccount**](docs/BankAccountApi.md#createfirmbankaccount) | **POST** /api/v3/partner/firms/{firm_id}/accounts | Create a bank account
*BankAccountApi* | [**DeleteFirmBankAccount**](docs/BankAccountApi.md#deletefirmbankaccount) | **DELETE** /api/v3/partner/firms/{firm_id}/accounts/{account_id} | Delete a bank account
...
*BankAccountApi* | [**GetFirmBankAccounts**](docs/BankAccountApi.md#getfirmbankaccounts) | **GET** /api/v3/partner/firms/{firm_id}/accounts | List bank accounts
*BankAccountApi* | [**PatchFirmBankAccountExternalAccountID**](docs/BankAccountApi.md#patchfirmbankaccountexternalaccountid) | **PATCH** /api/v3/partner/firms/{firm_id}/accounts/{account_id} | Patch an external account ID for a bank account.
...
*FirmApi* | [**Associate**](docs/FirmApi.md#associate) | **POST** /api/v3/partner/firms/connect/{firm_connect_id}/associate | Associate a firm with an affiliate
...
*FirmApi* | [**CreateFirmBankAccount**](docs/FirmApi.md#createfirmbankaccount) | **POST** /api/v3/partner/firms/{firm_id}/accounts | Create a bank account
...
*FirmApi* | [**DeleteFirmBankAccount**](docs/FirmApi.md#deletefirmbankaccount) | **DELETE** /api/v3/partner/firms/{firm_id}/accounts/{account_id} | Delete a bank account
...
*FirmApi* | [**GetFirmBankAccounts**](docs/FirmApi.md#getfirmbankaccounts) | **GET** /api/v3/partner/firms/{firm_id}/accounts | List bank accounts
*FirmApi* | [**GetFirmBranding**](docs/FirmApi.md#getfirmbranding) | **GET** /api/v3/partner/firms/{firm_id}/branding | Get firm branding
...
*FirmApi* | [**GetFirmPricing**](docs/FirmApi.md#getfirmpricing) | **GET** /api/v3/partner/firms/{firm_id}/pricing | List the pricing products for a firm and their constraints.
...
*FirmApi* | [**PatchFirmBankAccountExternalAccountID**](docs/FirmApi.md#patchfirmbankaccountexternalaccountid) | **PATCH** /api/v3/partner/firms/{firm_id}/accounts/{account_id} | Patch an external account ID for a bank account.
...
*FirmApi* | [**PutSurchargingStatus**](docs/FirmApi.md#putsurchargingstatus) | **PUT** /api/v3/partner/firms/{firm_id}/surcharging/status/{status} | Toggle surcharging status
...
*FirmApi* | [**ToggleFirmProducts**](docs/FirmApi.md#togglefirmproducts) | **POST** /api/v3/partner/firms/{firm_id}/products | 
*PartnerApi* | [**GetPartnerBranding**](docs/PartnerApi.md#getpartnerbranding) | **GET** /api/v3/partner/branding | Get partner branding
*PartnerApi* | [**PostPartnerBrandingColour**](docs/PartnerApi.md#postpartnerbrandingcolour) | **POST** /api/v3/partner/branding/colour | Set partner colour
...
*PaymentsApi* | [**CreateChargeAndPayWithCustomerPaymentToken**](docs/PaymentsApi.md#createchargeandpaywithcustomerpaymenttoken) | **POST** /api/v3/partner/firms/{firm_id}/charges/payment_token/{payment_token} | DEPRECATED - Use /api/v4/partner/firms/{firm_id}/charges/payment-token/{payment_token} endpoint instead
*PaymentsApi* | [**CreateChargePayment**](docs/PaymentsApi.md#createchargepayment) | **POST** /api/v4/partner/firms/{firm_id}/charges/payment-token/{payment_token} | Create Charge, and pay directly.
...
*PaymentsApi* | [**GetArtifactByFirmExternalIDAndPaymentReferenceNumber**](docs/PaymentsApi.md#getartifactbyfirmexternalidandpaymentreferencenumber) | **GET** /api/v3/partner/firms/external/{external_firm_id}/artifacts/{feewise_payment_reference_number} | Get a firm's artifact by its FeeWise payment reference number
*PaymentsApi* | [**GetArtifactsByFirmExternalID**](docs/PaymentsApi.md#getartifactsbyfirmexternalid) | **GET** /api/v3/partner/firms/external/{external_firm_id}/artifacts | Get a firm's artifacts by its external ID
...
*PaymentsApi* | [**GetDebtorStatement**](docs/PaymentsApi.md#getdebtorstatement) | **GET** /api/v3/partner/statements/debtors/{debtor_id} | Get a debtor statement
...
*PaymentsApi* | [**GetRefundDetails**](docs/PaymentsApi.md#getrefunddetails) | **GET** /api/v3/partner/firms/{firm_id}/payments/refund/details | Get Refund Details
...
*PaymentsApi* | [**PostConfirmChargePayment**](docs/PaymentsApi.md#postconfirmchargepayment) | **POST** /api/v3/partner/firms/{firm_id}/charges/{charge_id}/payments/{payment_id}/confirm | Confirm a pending charge payment.
*PaymentsApi* | [**PostPaymentDetails**](docs/PaymentsApi.md#postpaymentdetails) | **POST** /api/v3/partner/firms/{firm_id}/payment/details | Retrieve the payment details for a matter, debtor, invoice or trust request.
*PaymentsApi* | [**PostPaymentDetailsBulk**](docs/PaymentsApi.md#postpaymentdetailsbulk) | **POST** /api/v3/partner/firms/{firm_id}/payment/details/bulk | Retrieve payment details for multiple matters, debtors, invoices or trust requests in bulk.
...
*PaymentsApi* | [**UpdateArtifactAccount**](docs/PaymentsApi.md#updateartifactaccount) | **POST** /api/v3/partner/firms/{firm_id}/artifacts/settlement-account/{settlement_account_id}/replace | Update the settlement account for unpaid artifacts.
*PaymentsApi* | [**UpdateArtifactRedirectURL**](docs/PaymentsApi.md#updateartifactredirecturl) | **PATCH** /api/v3/partner/firms/{firm_id}/artifacts/{artifact_id}/update-redirect | Update the payment redirect URL for an artifact
...
*TransactionsApi* | [**GetFirmTransactionsV4**](docs/TransactionsApi.md#getfirmtransactionsv4) | **GET** /api/v4/partner/firms/{firm_id}/transactions | 
*TransactionsApi* | [**GetTransactionById**](docs/TransactionsApi.md#gettransactionbyid) | **GET** /api/v3/partner/transactions/{transaction_id} | 
...
## Documentation for Models
 ...
 - [Model.ArtifactResponse](docs/ArtifactResponse.md)
 - [Model.ArtifactSubtype](docs/ArtifactSubtype.md)
 ...
 - [Model.ChargePaymentDetails](docs/ChargePaymentDetails.md)
 - [Model.ChargeResponse](docs/ChargeResponse.md)
 - [Model.Company](docs/Company.md)
 - [Model.CreateChargePayment402Response](docs/CreateChargePayment402Response.md)
 - [Model.CreateChargePaymentRequest](docs/CreateChargePaymentRequest.md)
 ...
 - [Model.DebtorStatement](docs/DebtorStatement.md)
 - [Model.EnabledType](docs/EnabledType.md)
 ...
 - [Model.ExamplePrice](docs/ExamplePrice.md)
 ...
 - [Model.FirmAffiliationCreatedEvent](docs/FirmAffiliationCreatedEvent.md)
 - [Model.FirmArtifactSummary](docs/FirmArtifactSummary.md)
 - [Model.FirmArtifactsResponse](docs/FirmArtifactsResponse.md)
 - [Model.FirmAuth](docs/FirmAuth.md)
 - [Model.FirmAuthResponse](docs/FirmAuthResponse.md)
 ...
 - [Model.FirmPricingUpdatedEvent](docs/FirmPricingUpdatedEvent.md)
 - [Model.FirmResponse](docs/FirmResponse.md)
 - [Model.FirmStatusUpdatedEvent](docs/FirmStatusUpdatedEvent.md)
 - [Model.FirmSurchargeSettingsEvent](docs/FirmSurchargeSettingsEvent.md)
 ...
 - [Model.MatterSummary](docs/MatterSummary.md)
 - [Model.MetadataSearch](docs/MetadataSearch.md)
 - [Model.OptionalProductSettings](docs/OptionalProductSettings.md)
 - [Model.PaginationMetadata](docs/PaginationMetadata.md)
 - [Model.PartyBranding](docs/PartyBranding.md)
 - [Model.PatchFirmBankAccountExternalAccountIDRequest](docs/PatchFirmBankAccountExternalAccountIDRequest.md)
 - [Model.Payer](docs/Payer.md)
 - [Model.Payment](docs/Payment.md)
 - [Model.PaymentAuthorisedEvent](docs/PaymentAuthorisedEvent.md)
 - [Model.PaymentDetailType](docs/PaymentDetailType.md)
 ...
 - [Model.PostConfirmChargePaymentRequest](docs/PostConfirmChargePaymentRequest.md)
 - [Model.PostFirmBrandingColourRequest](docs/PostFirmBrandingColourRequest.md)
 - [Model.PostPartnerBrandingColourRequest](docs/PostPartnerBrandingColourRequest.md)
 - [Model.PostPartnerLogoUpload200Response](docs/PostPartnerLogoUpload200Response.md)
 - [Model.PostPaymentDetails200Response](docs/PostPaymentDetails200Response.md)
 - [Model.PostPaymentDetailsBulk200Response](docs/PostPaymentDetailsBulk200Response.md)
 ...
 - [Model.PutSurchargingStatusRequest](docs/PutSurchargingStatusRequest.md)
 - [Model.ReceiptObject](docs/ReceiptObject.md)
 - [Model.Refund](docs/Refund.md)
 - [Model.RefundResponse](docs/RefundResponse.md)
 - [Model.RefundStatus](docs/RefundStatus.md)
 - [Model.RiskAssessment](docs/RiskAssessment.md)
 ...
 - [Model.SurchargeSettings](docs/SurchargeSettings.md)
 - [Model.SurchargeSettingsResponse](docs/SurchargeSettingsResponse.md)
 - [Model.SurchargingStatus](docs/SurchargingStatus.md)
 - [Model.TermsOfService](docs/TermsOfService.md)
 - [Model.ToggleFirmProducts200Response](docs/ToggleFirmProducts200Response.md)
 ...
 - [Model.TransactionV2AllOf](docs/TransactionV2AllOf.md)
 - [Model.TransactionsResponse](docs/TransactionsResponse.md)
 - [Model.TransactionsResponseV2](docs/TransactionsResponseV2.md)
 - [Model.TrustDeposit](docs/TrustDeposit.md)
 - [Model.TrustDepositResponse](docs/TrustDepositResponse.md)
 - [Model.UpdateArtifactAccountRequest](docs/UpdateArtifactAccountRequest.md)
 - [Model.UpdateArtifactRedirectURLRequest](docs/UpdateArtifactRedirectURLRequest.md)
 - [Model.UpdatedCount](docs/UpdatedCount.md)
...
- **Type**: API key
- **API key parameter name**: X-FIRM-API-KEY
- **Location**: HTTP header
...
- **Type**: API key
- **API key parameter name**: X-FIRM-ID
- **Location**: HTTP header
