...
*FirmApi* | [**PostUpload**](docs/FirmApi.md#postupload) | **POST** /api/v3/partner/firms/{firm_id}/upload | 
...
*PartnerApi* | [**GetPartnerBranding**](docs/PartnerApi.md#getpartnerbranding) | **GET** /api/v3/partner/branding | 
*PartnerApi* | [**PostPartnerLogoUpload**](docs/PartnerApi.md#postpartnerlogoupload) | **POST** /api/v3/partner/upload | 
...
*PaymentsApi* | [**CreateChargeAndPayWithCustomerPaymentToken**](docs/PaymentsApi.md#createchargeandpaywithcustomerpaymenttoken) | **POST** /api/v3/partner/firms/{firm_id}/charges/payment_token/{payment_token} | Create a Charge, and pay directly, using a customer payment token.
*PaymentsApi* | [**CreateInvoice**](docs/PaymentsApi.md#createinvoice) | **POST** /api/v3/partner/invoices | Create an Invoice
*PaymentsApi* | [**CreateMatter**](docs/PaymentsApi.md#creatematter) | **POST** /api/v3/partner/matters | 
...
*PaymentsApi* | [**GetDebtorMatterStatement**](docs/PaymentsApi.md#getdebtormatterstatement) | **GET** /api/v3/partner/statements/debtors/{debtor_id}/matters/{matter_id} | 
...
*PaymentsApi* | [**GetMatterStatement**](docs/PaymentsApi.md#getmatterstatement) | **GET** /api/v3/partner/statements/matters/{matter_id} | 
...
*PayoutsApi* | [**GetChannelPartnerPayouts**](docs/PayoutsApi.md#getchannelpartnerpayouts) | **GET** /api/v3/partner/payouts | 
*PayoutsApi* | [**GetFirmPayouts**](docs/PayoutsApi.md#getfirmpayouts) | **GET** /api/v3/partner/payouts/firms/{firm_id} | 
...
## Documentation for Models
 ...
 - [Model.CustomerPaymentMethodAllOf](docs/CustomerPaymentMethodAllOf.md)
