...
namespace FeeWise.Test.Api
{
    ...
    public class PartnerApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test PostPartnerBrandingColour
        /// </summary>
        [Fact]
        public void PostPartnerBrandingColourTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = null;
            //instance.PostPartnerBrandingColour(postPartnerBrandingColourRequest);
        }
