...
namespace FeeWise.Test.Api
{
    ...
    public class TransactionsApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GetFirmTransactionsV4
        /// </summary>
        [Fact]
        public void GetFirmTransactionsV4Test()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid firmId = null;
            //DateTime? from = null;
            ...
            //List<string> statusFilter = null;
            //List<Guid> accountIdFilter = null;
            //var response = instance.GetFirmTransactionsV4(firmId, from, to, page, pageSize, sortBy, order, statusFilter, accountIdFilter);
            //Assert.IsType<TransactionsResponseV2>(response);
        }
