...
namespace FeeWise.Api
{
    ...
    public interface IBankAccountApiSync : IApiAccessor
    {
        ...
        /// <param name="firmId"></param>
        /// <param name="accountId"></param>
        /// <param name="patchFirmBankAccountExternalAccountIDRequest">Bank account external account ID</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BankAccount</returns>
        BankAccount PatchFirmBankAccountExternalAccountID(Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BankAccount</returns>
        ApiResponse<BankAccount> PatchFirmBankAccountExternalAccountIDWithHttpInfo(Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest, int operationIndex = 0);
        /// <summary>
    ...
    public interface IBankAccountApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BankAccount</returns>
        System.Threading.Tasks.Task<BankAccount> PatchFirmBankAccountExternalAccountIDAsync(Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BankAccount)</returns>
        System.Threading.Tasks.Task<ApiResponse<BankAccount>> PatchFirmBankAccountExternalAccountIDWithHttpInfoAsync(Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Set firms default bank account.
        /// </summary>
        /// <remarks>
    ...
    public partial class BankAccountApi : IBankAccountApi
    {
        ...
        /// <summary>
        /// Patch an external account ID for a bank account. Patch an external account ID for a bank account.  Most properties of bank accounts are immutable once created, however the external account ID can be updated. nb: Successful calls to this endpoint will throw a &#x60;firm.bank-account.updated&#x60; event. 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="firmId"></param>
        /// <param name="accountId"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>BankAccount</returns>
        public BankAccount PatchFirmBankAccountExternalAccountID(Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<BankAccount> localVarResponse = PatchFirmBankAccountExternalAccountIDWithHttpInfo(firmId, accountId, patchFirmBankAccountExternalAccountIDRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of BankAccount</returns>
        public FeeWise.Client.ApiResponse<BankAccount> PatchFirmBankAccountExternalAccountIDWithHttpInfo(Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest, int operationIndex = 0)
        {
            // verify the required parameter 'patchFirmBankAccountExternalAccountIDRequest' is set
            if (patchFirmBankAccountExternalAccountIDRequest == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'patchFirmBankAccountExternalAccountIDRequest' when calling BankAccountApi->PatchFirmBankAccountExternalAccountID");
            }
            ...
            localVarRequestOptions.PathParameters.Add("firm_id", FeeWise.Client.ClientUtils.ParameterToString(firmId)); // path parameter
            localVarRequestOptions.PathParameters.Add("account_id", FeeWise.Client.ClientUtils.ParameterToString(accountId)); // path parameter
            localVarRequestOptions.Data = patchFirmBankAccountExternalAccountIDRequest;

            localVarRequestOptions.Operation = "BankAccountApi.PatchFirmBankAccountExternalAccountID";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Patch<BankAccount>("/api/v3/partner/firms/{firm_id}/accounts/{account_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PatchFirmBankAccountExternalAccountID", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of BankAccount</returns>
        public async System.Threading.Tasks.Task<BankAccount> PatchFirmBankAccountExternalAccountIDAsync(Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<BankAccount> localVarResponse = await PatchFirmBankAccountExternalAccountIDWithHttpInfoAsync(firmId, accountId, patchFirmBankAccountExternalAccountIDRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (BankAccount)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<BankAccount>> PatchFirmBankAccountExternalAccountIDWithHttpInfoAsync(Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'patchFirmBankAccountExternalAccountIDRequest' is set
            if (patchFirmBankAccountExternalAccountIDRequest == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PatchAsync<BankAccount>("/api/v3/partner/firms/{firm_id}/accounts/{account_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
