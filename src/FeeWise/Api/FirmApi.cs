...
namespace FeeWise.Api
{
    ...
    public interface IFirmApiSync : IApiAccessor
    {
        ...
        /// <returns>CreateFirmResponse</returns>
        CreateFirmResponse CreateFirm(CreateFirm createFirm, int operationIndex = 0);
        ...
        /// <param name="createFirm">Firm Details</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateFirmResponse</returns>
        ApiResponse<CreateFirmResponse> CreateFirmWithHttpInfo(CreateFirm createFirm, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="debtor">Customer details</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PaymentTokenResponse</returns>
        PaymentTokenResponse CreatePaymentToken(Guid firmId, Debtor debtor, int operationIndex = 0);
        ...
        ApiResponse<PaymentTokenResponse> CreatePaymentTokenWithHttpInfo(Guid firmId, Debtor debtor, int operationIndex = 0);
        /// <summary>
        /// Get a firm
        /// </summary>
        /// <remarks>
    ...
    public interface IFirmApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of CreateFirmResponse</returns>
        System.Threading.Tasks.Task<CreateFirmResponse> CreateFirmAsync(CreateFirm createFirm, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateFirmResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<CreateFirmResponse>> CreateFirmWithHttpInfoAsync(CreateFirm createFirm, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a payment token for a customer.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<PaymentTokenResponse> CreatePaymentTokenAsync(Guid firmId, Debtor debtor, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PaymentTokenResponse>> CreatePaymentTokenWithHttpInfoAsync(Guid firmId, Debtor debtor, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a firm
        /// </summary>
        /// <remarks>
    ...
    public partial class FirmApi : IFirmApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>CreateFirmResponse</returns>
        public CreateFirmResponse CreateFirm(CreateFirm createFirm, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<CreateFirmResponse> localVarResponse = CreateFirmWithHttpInfo(createFirm);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CreateFirmResponse</returns>
        public FeeWise.Client.ApiResponse<CreateFirmResponse> CreateFirmWithHttpInfo(CreateFirm createFirm, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Post<CreateFirmResponse>("/api/v3/partner/firms", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of CreateFirmResponse</returns>
        public async System.Threading.Tasks.Task<CreateFirmResponse> CreateFirmAsync(CreateFirm createFirm, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<CreateFirmResponse> localVarResponse = await CreateFirmWithHttpInfoAsync(createFirm, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CreateFirmResponse)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<CreateFirmResponse>> CreateFirmWithHttpInfoAsync(CreateFirm createFirm, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createFirm' is set
            if (createFirm == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<CreateFirmResponse>("/api/v3/partner/firms", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PaymentTokenResponse</returns>
        public PaymentTokenResponse CreatePaymentToken(Guid firmId, Debtor debtor, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<PaymentTokenResponse> localVarResponse = CreatePaymentTokenWithHttpInfo(firmId, debtor);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PaymentTokenResponse</returns>
        public FeeWise.Client.ApiResponse<PaymentTokenResponse> CreatePaymentTokenWithHttpInfo(Guid firmId, Debtor debtor, int operationIndex = 0)
        {
            // verify the required parameter 'debtor' is set
            if (debtor == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'debtor' when calling FirmApi->CreatePaymentToken");
            }
            ...
            localVarRequestOptions.Data = debtor;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PaymentTokenResponse</returns>
        public async System.Threading.Tasks.Task<PaymentTokenResponse> CreatePaymentTokenAsync(Guid firmId, Debtor debtor, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<PaymentTokenResponse> localVarResponse = await CreatePaymentTokenWithHttpInfoAsync(firmId, debtor, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PaymentTokenResponse)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<PaymentTokenResponse>> CreatePaymentTokenWithHttpInfoAsync(Guid firmId, Debtor debtor, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'debtor' is set
            if (debtor == null)
            {
