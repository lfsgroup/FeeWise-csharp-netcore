...
namespace FeeWise.Api
{
    ...
    public interface IFirmApiSync : IApiAccessor
    {
        ...
        PostUpload200Response PostUpload(Guid firmId, string filePurpose, Guid? personId = default(Guid?), System.IO.Stream fwUploadFile = default(System.IO.Stream), int operationIndex = 0);
        ...
        ApiResponse<PostUpload200Response> PostUploadWithHttpInfo(Guid firmId, string filePurpose, Guid? personId = default(Guid?), System.IO.Stream fwUploadFile = default(System.IO.Stream), int operationIndex = 0);
        /// <summary>
    ...
    public interface IFirmApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PostUpload200Response> PostUploadAsync(Guid firmId, string filePurpose, Guid? personId = default(Guid?), System.IO.Stream fwUploadFile = default(System.IO.Stream), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class FirmApi : IFirmApi
    {
        ...
        /// <summary>
        /// Get firm details Get firm details by Firm ID (UUID) - This is the FeeWise unique ID for a firm OR by External ID (string), the partner&#39;s own unique id for a firm. Both will return the same model 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="firmId">Firm ID (UUID) (optional)</param>
        /// <param name="externalId">External ID (string) (optional)</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PostUpload200Response</returns>
        public PostUpload200Response PostUpload(Guid firmId, string filePurpose, Guid? personId = default(Guid?), System.IO.Stream fwUploadFile = default(System.IO.Stream), int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<PostUpload200Response> localVarResponse = PostUploadWithHttpInfo(firmId, filePurpose, personId, fwUploadFile);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PostUpload200Response</returns>
        public FeeWise.Client.ApiResponse<PostUpload200Response> PostUploadWithHttpInfo(Guid firmId, string filePurpose, Guid? personId = default(Guid?), System.IO.Stream fwUploadFile = default(System.IO.Stream), int operationIndex = 0)
        {
        ...
        {
            FeeWise.Client.ApiResponse<PostUpload200Response> localVarResponse = await PostUploadWithHttpInfoAsync(firmId, filePurpose, personId, fwUploadFile, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
