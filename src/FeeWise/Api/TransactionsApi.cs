...
namespace FeeWise.Api
{
    ...
    public interface ITransactionsApiSync : IApiAccessor
    {
        ...
        /// <param name="accountIdFilter">Filter by account id nb: Example usage, comma separated, in query... /transactions?account_id&#x3D;57d43c4e-f18d-40ae-9511-2aeafbf68def,b7dc7851-5cc4-41d5-8174-f00ad916f76b  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TransactionsResponseV2</returns>
        TransactionsResponseV2 GetFirmTransactionsV4(Guid firmId, DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), int? page = default(int?), int? pageSize = default(int?), string sortBy = default(string), string order = default(string), List<string> statusFilter = default(List<string>), List<Guid> accountIdFilter = default(List<Guid>), int operationIndex = 0);
        ...
        /// <param name="accountIdFilter">Filter by account id nb: Example usage, comma separated, in query... /transactions?account_id&#x3D;57d43c4e-f18d-40ae-9511-2aeafbf68def,b7dc7851-5cc4-41d5-8174-f00ad916f76b  (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionsResponseV2</returns>
        ApiResponse<TransactionsResponseV2> GetFirmTransactionsV4WithHttpInfo(Guid firmId, DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), int? page = default(int?), int? pageSize = default(int?), string sortBy = default(string), string order = default(string), List<string> statusFilter = default(List<string>), List<Guid> accountIdFilter = default(List<Guid>), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        TransactionResponse GetTransactionById(Guid transactionId, int operationIndex = 0);
        ...
        ApiResponse<TransactionResponse> GetTransactionByIdWithHttpInfo(Guid transactionId, int operationIndex = 0);
    ...
    public interface ITransactionsApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TransactionsResponseV2</returns>
        System.Threading.Tasks.Task<TransactionsResponseV2> GetFirmTransactionsV4Async(Guid firmId, DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), int? page = default(int?), int? pageSize = default(int?), string sortBy = default(string), string order = default(string), List<string> statusFilter = default(List<string>), List<Guid> accountIdFilter = default(List<Guid>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TransactionsResponseV2)</returns>
        System.Threading.Tasks.Task<ApiResponse<TransactionsResponseV2>> GetFirmTransactionsV4WithHttpInfoAsync(Guid firmId, DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), int? page = default(int?), int? pageSize = default(int?), string sortBy = default(string), string order = default(string), List<string> statusFilter = default(List<string>), List<Guid> accountIdFilter = default(List<Guid>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<TransactionResponse> GetTransactionByIdAsync(Guid transactionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TransactionResponse>> GetTransactionByIdWithHttpInfoAsync(Guid transactionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TransactionsApi : ITransactionsApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TransactionsResponseV2</returns>
        public TransactionsResponseV2 GetFirmTransactionsV4(Guid firmId, DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), int? page = default(int?), int? pageSize = default(int?), string sortBy = default(string), string order = default(string), List<string> statusFilter = default(List<string>), List<Guid> accountIdFilter = default(List<Guid>), int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<TransactionsResponseV2> localVarResponse = GetFirmTransactionsV4WithHttpInfo(firmId, from, to, page, pageSize, sortBy, order, statusFilter, accountIdFilter);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionsResponseV2</returns>
        public FeeWise.Client.ApiResponse<TransactionsResponseV2> GetFirmTransactionsV4WithHttpInfo(Guid firmId, DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), int? page = default(int?), int? pageSize = default(int?), string sortBy = default(string), string order = default(string), List<string> statusFilter = default(List<string>), List<Guid> accountIdFilter = default(List<Guid>), int operationIndex = 0)
        {
            FeeWise.Client.RequestOptions localVarRequestOptions = new FeeWise.Client.RequestOptions();
            ...
            localVarRequestOptions.Operation = "TransactionsApi.GetFirmTransactionsV4";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<TransactionsResponseV2>("/api/v4/partner/firms/{firm_id}/transactions", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetFirmTransactionsV4", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TransactionsResponseV2</returns>
        public async System.Threading.Tasks.Task<TransactionsResponseV2> GetFirmTransactionsV4Async(Guid firmId, DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), int? page = default(int?), int? pageSize = default(int?), string sortBy = default(string), string order = default(string), List<string> statusFilter = default(List<string>), List<Guid> accountIdFilter = default(List<Guid>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<TransactionsResponseV2> localVarResponse = await GetFirmTransactionsV4WithHttpInfoAsync(firmId, from, to, page, pageSize, sortBy, order, statusFilter, accountIdFilter, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TransactionsResponseV2)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<TransactionsResponseV2>> GetFirmTransactionsV4WithHttpInfoAsync(Guid firmId, DateTime? from = default(DateTime?), DateTime? to = default(DateTime?), int? page = default(int?), int? pageSize = default(int?), string sortBy = default(string), string order = default(string), List<string> statusFilter = default(List<string>), List<Guid> accountIdFilter = default(List<Guid>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TransactionsResponseV2>("/api/v4/partner/firms/{firm_id}/transactions", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>TransactionResponse</returns>
        public TransactionResponse GetTransactionById(Guid transactionId, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<TransactionResponse> localVarResponse = GetTransactionByIdWithHttpInfo(transactionId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TransactionResponse</returns>
        public FeeWise.Client.ApiResponse<TransactionResponse> GetTransactionByIdWithHttpInfo(Guid transactionId, int operationIndex = 0)
        {
            FeeWise.Client.RequestOptions localVarRequestOptions = new FeeWise.Client.RequestOptions();
            ...
            localVarRequestOptions.PathParameters.Add("transaction_id", FeeWise.Client.ClientUtils.ParameterToString(transactionId)); // path parameter

            localVarRequestOptions.Operation = "TransactionsApi.GetTransactionById";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<TransactionResponse>("/api/v3/partner/transactions/{transaction_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TransactionResponse</returns>
        public async System.Threading.Tasks.Task<TransactionResponse> GetTransactionByIdAsync(Guid transactionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<TransactionResponse> localVarResponse = await GetTransactionByIdWithHttpInfoAsync(transactionId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TransactionResponse)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<TransactionResponse>> GetTransactionByIdWithHttpInfoAsync(Guid transactionId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<TransactionResponse>("/api/v3/partner/transactions/{transaction_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
