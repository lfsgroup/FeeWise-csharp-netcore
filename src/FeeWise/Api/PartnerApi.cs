...
namespace FeeWise.Api
{
    ...
    public interface IPartnerApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postPartnerBrandingColourRequest"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void PostPartnerBrandingColour(PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = default(PostPartnerBrandingColourRequest), int operationIndex = 0);
        ...
        ApiResponse<Object> PostPartnerBrandingColourWithHttpInfo(PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = default(PostPartnerBrandingColourRequest), int operationIndex = 0);
        /// <summary>
        /// Upload partner logo
        /// </summary>
        /// <remarks>
    ...
    public interface IPartnerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task PostPartnerBrandingColourAsync(PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = default(PostPartnerBrandingColourRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> PostPartnerBrandingColourWithHttpInfoAsync(PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = default(PostPartnerBrandingColourRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Upload partner logo
        /// </summary>
        /// <remarks>
    ...
    public partial class PartnerApi : IPartnerApi
    {
        ...
        /// <summary>
        /// Set partner colour Sets a partner colour. This colour will be used as default colour in FeeWise dashboard and can be overwritten by firm&#39;s branding colour.
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="postPartnerBrandingColourRequest"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void PostPartnerBrandingColour(PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = default(PostPartnerBrandingColourRequest), int operationIndex = 0)
        {
            PostPartnerBrandingColourWithHttpInfo(postPartnerBrandingColourRequest);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public FeeWise.Client.ApiResponse<Object> PostPartnerBrandingColourWithHttpInfo(PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = default(PostPartnerBrandingColourRequest), int operationIndex = 0)
        {
            FeeWise.Client.RequestOptions localVarRequestOptions = new FeeWise.Client.RequestOptions();
            ...
            localVarRequestOptions.Data = postPartnerBrandingColourRequest;

            localVarRequestOptions.Operation = "PartnerApi.PostPartnerBrandingColour";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/api/v3/partner/branding/colour", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostPartnerBrandingColour", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task PostPartnerBrandingColourAsync(PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = default(PostPartnerBrandingColourRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await PostPartnerBrandingColourWithHttpInfoAsync(postPartnerBrandingColourRequest, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<Object>> PostPartnerBrandingColourWithHttpInfoAsync(PostPartnerBrandingColourRequest postPartnerBrandingColourRequest = default(PostPartnerBrandingColourRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/v3/partner/branding/colour", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
