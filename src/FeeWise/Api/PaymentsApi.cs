...
namespace FeeWise.Api
{
    ...
    public interface IPaymentsApiSync : IApiAccessor
    {
        ...
        ChargeResponse CreateCharge(Charge charge, int operationIndex = 0);
        ...
        ApiResponse<ChargeResponse> CreateChargeWithHttpInfo(Charge charge, int operationIndex = 0);
        /// <summary>
        ...
        ChargeAndPayResponse CreateChargeAndPayWithCustomerPaymentToken(Guid paymentToken, Charge charge, int operationIndex = 0);
        ...
        ApiResponse<ChargeAndPayResponse> CreateChargeAndPayWithCustomerPaymentTokenWithHttpInfo(Guid paymentToken, Charge charge, int operationIndex = 0);
        /// <summary>
        /// Create an Invoice
        /// </summary>
        /// <remarks>
    ...
    public interface IPaymentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ChargeResponse> CreateChargeAsync(Charge charge, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ChargeResponse>> CreateChargeWithHttpInfoAsync(Charge charge, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a Charge, and pay directly, using a customer payment token.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ChargeAndPayResponse> CreateChargeAndPayWithCustomerPaymentTokenAsync(Guid paymentToken, Charge charge, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ChargeAndPayResponse>> CreateChargeAndPayWithCustomerPaymentTokenWithHttpInfoAsync(Guid paymentToken, Charge charge, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create an Invoice
        /// </summary>
        /// <remarks>
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <summary>
        /// Create a Charge Create an charge for a channel partner.   NB the fields &#x60;charge_id&#x60;, and &#x60;payment_uri&#x60; must NOT be supplied. If supplied, BadResponse will be returned.   These are populated once the charge has been created and will be available in the response. 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="charge">Charge details</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ChargeResponse</returns>
        public ChargeResponse CreateCharge(Charge charge, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<ChargeResponse> localVarResponse = CreateChargeWithHttpInfo(charge);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeResponse</returns>
        public FeeWise.Client.ApiResponse<ChargeResponse> CreateChargeWithHttpInfo(Charge charge, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ChargeResponse>("/api/v3/partner/charges", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ChargeResponse</returns>
        public async System.Threading.Tasks.Task<ChargeResponse> CreateChargeAsync(Charge charge, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<ChargeResponse> localVarResponse = await CreateChargeWithHttpInfoAsync(charge, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ChargeResponse)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<ChargeResponse>> CreateChargeWithHttpInfoAsync(Charge charge, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'charge' is set
            if (charge == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ChargeResponse>("/api/v3/partner/charges", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a Charge, and pay directly, using a customer payment token. Create an charge (and pay for it) for a channel partner, using an existing customer payment token.  A list of customer payment tokens can be retrieved from the &#x60;/customers&#x60; endpoint.  NB the fields &#x60;charge_id&#x60;, and &#x60;payment_uri&#x60; must NOT be supplied. If supplied, BadResponse will be returned.   These are populated once the charge has been created and will be available in the response. 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="paymentToken"></param>
        /// <param name="charge">Charge details, using an existing customer payment token</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ChargeAndPayResponse</returns>
        public ChargeAndPayResponse CreateChargeAndPayWithCustomerPaymentToken(Guid paymentToken, Charge charge, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<ChargeAndPayResponse> localVarResponse = CreateChargeAndPayWithCustomerPaymentTokenWithHttpInfo(paymentToken, charge);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ChargeAndPayResponse</returns>
        public FeeWise.Client.ApiResponse<ChargeAndPayResponse> CreateChargeAndPayWithCustomerPaymentTokenWithHttpInfo(Guid paymentToken, Charge charge, int operationIndex = 0)
        {
            // verify the required parameter 'charge' is set
            if (charge == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<ChargeAndPayResponse>("/api/v3/partner/charges/pay/payment_token/{payment_token}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ChargeAndPayResponse</returns>
        public async System.Threading.Tasks.Task<ChargeAndPayResponse> CreateChargeAndPayWithCustomerPaymentTokenAsync(Guid paymentToken, Charge charge, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<ChargeAndPayResponse> localVarResponse = await CreateChargeAndPayWithCustomerPaymentTokenWithHttpInfoAsync(paymentToken, charge, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ChargeAndPayResponse)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<ChargeAndPayResponse>> CreateChargeAndPayWithCustomerPaymentTokenWithHttpInfoAsync(Guid paymentToken, Charge charge, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'charge' is set
            if (charge == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<ChargeAndPayResponse>("/api/v3/partner/charges/pay/payment_token/{payment_token}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Search for payments for the channel partner Search for payments for a channel partner..         The filters supplied in the query params must *all* be met.         The channel partner is derived from the PartnerAuth security context. 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="paymentId">Get a specific payment. If this is specified, other query params should not be specified  and will result in a BadRequest if the are.  (optional)</param>
        /// <param name="artifactId">Get payments only for the specified artifact (Invoice/Trust Desposit)  (optional)</param>
