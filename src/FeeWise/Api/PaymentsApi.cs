...
namespace FeeWise.Api
{
    ...
    public interface IPaymentsApiSync : IApiAccessor
    {
        ...
        StatementResponse CreateStatement(Statement statement = default(Statement), int operationIndex = 0);
        ...
        ApiResponse<StatementResponse> CreateStatementWithHttpInfo(Statement statement = default(Statement), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        void RecordExternalPayment(ExternalPayment externalPayment, int operationIndex = 0);
        ...
        ApiResponse<Object> RecordExternalPaymentWithHttpInfo(ExternalPayment externalPayment, int operationIndex = 0);
    ...
    public interface IPaymentsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<StatementResponse> CreateStatementAsync(Statement statement = default(Statement), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<StatementResponse>> CreateStatementWithHttpInfoAsync(Statement statement = default(Statement), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Create a Trust Deposit
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task RecordExternalPaymentAsync(ExternalPayment externalPayment, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> RecordExternalPaymentWithHttpInfoAsync(ExternalPayment externalPayment, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <summary>
        /// Create an Invoice Create an invoice for a channel partner.   NB the fields &#x60;invoice_id&#x60;, &#x60;payment_uri&#x60; and &#x60;status&#x60; must NOT be supplied. If supplied, BadResponse will be returned.   These are populated once the invoice has been created and will be available in the response 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="invoice">Invoice details</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>StatementResponse</returns>
        public StatementResponse CreateStatement(Statement statement = default(Statement), int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<StatementResponse> localVarResponse = CreateStatementWithHttpInfo(statement);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of StatementResponse</returns>
        public FeeWise.Client.ApiResponse<StatementResponse> CreateStatementWithHttpInfo(Statement statement = default(Statement), int operationIndex = 0)
        {
            FeeWise.Client.RequestOptions localVarRequestOptions = new FeeWise.Client.RequestOptions();
            ...
            localVarRequestOptions.Data = statement;

            localVarRequestOptions.Operation = "PaymentsApi.CreateStatement";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<StatementResponse>("/api/v3/partner/statements", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("CreateStatement", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of StatementResponse</returns>
        public async System.Threading.Tasks.Task<StatementResponse> CreateStatementAsync(Statement statement = default(Statement), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<StatementResponse> localVarResponse = await CreateStatementWithHttpInfoAsync(statement, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (StatementResponse)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<StatementResponse>> CreateStatementWithHttpInfoAsync(Statement statement = default(Statement), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<StatementResponse>("/api/v3/partner/statements", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Create a Trust Deposit Create a trust deposit for a channel partner.   NB the fields trust_deposit_id, payment_uri and status must NOT be supplied. If supplied, BadResponse will be returned.   These are populated once the trust deposit has been created and will be available in the response 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="trustDeposit">Trust deposit details</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns></returns>
        public void RecordExternalPayment(ExternalPayment externalPayment, int operationIndex = 0)
        {
            RecordExternalPaymentWithHttpInfo(externalPayment);
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public FeeWise.Client.ApiResponse<Object> RecordExternalPaymentWithHttpInfo(ExternalPayment externalPayment, int operationIndex = 0)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/api/v3/partner/payments/external", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task RecordExternalPaymentAsync(ExternalPayment externalPayment, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await RecordExternalPaymentWithHttpInfoAsync(externalPayment, operationIndex, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<Object>> RecordExternalPaymentWithHttpInfoAsync(ExternalPayment externalPayment, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'externalPayment' is set
            if (externalPayment == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/v3/partner/payments/external", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
