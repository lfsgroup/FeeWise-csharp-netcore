...
namespace FeeWise.Api
{
    ...
    public interface IPaymentsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="externalFirmId">The ID of the firm in the partner&#39;s system.</param>
        /// <param name="feewisePaymentReferenceNumber">The FeeWise payment reference number of the artifact.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>FirmArtifactSummary</returns>
        [Obsolete]
        FirmArtifactSummary GetArtifactByFirmExternalIDAndPaymentReferenceNumber(string externalFirmId, string feewisePaymentReferenceNumber, int operationIndex = 0);
        ...
        /// <param name="feewisePaymentReferenceNumber">The FeeWise payment reference number of the artifact.</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of FirmArtifactSummary</returns>
        [Obsolete]
        ApiResponse<FirmArtifactSummary> GetArtifactByFirmExternalIDAndPaymentReferenceNumberWithHttpInfo(string externalFirmId, string feewisePaymentReferenceNumber, int operationIndex = 0);
        /// <summary>
        ...
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="externalFirmId">The ID of the firm in the partner&#39;s system.</param>
        /// <param name="updatedFrom">Return artifacts (invoices, trust deposits, etc...) updated at or after this timestamp. (optional)</param>
        /// <param name="updatedTo">Inclusively filter artifacts updated at or before this timestamp. (optional)</param>
        /// <param name="artifactTypes">Inclusively filter by artifact type. Multiple values are comma-separated. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>FirmArtifactsResponse</returns>
        [Obsolete]
        FirmArtifactsResponse GetArtifactsByFirmExternalID(string externalFirmId, DateTime? updatedFrom = default(DateTime?), DateTime? updatedTo = default(DateTime?), List<ArtifactType> artifactTypes = default(List<ArtifactType>), int operationIndex = 0);
        ...
        /// <param name="artifactTypes">Inclusively filter by artifact type. Multiple values are comma-separated. (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of FirmArtifactsResponse</returns>
        [Obsolete]
        ApiResponse<FirmArtifactsResponse> GetArtifactsByFirmExternalIDWithHttpInfo(string externalFirmId, DateTime? updatedFrom = default(DateTime?), DateTime? updatedTo = default(DateTime?), List<ArtifactType> artifactTypes = default(List<ArtifactType>), int operationIndex = 0);
        /// <summary>
        ...
        /// </remarks>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="firmId">Can be internal FeeWise ID or Partners Firm ID</param>
        /// <param name="paymentDetailsRequest"></param>
        /// <param name="accept">Desired response content type. Defaults to &#x60;application/json&#x60;. (optional, default to application/json)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PostPaymentDetails200Response</returns>
        PostPaymentDetails200Response PostPaymentDetails(string firmId, PaymentDetailsRequest paymentDetailsRequest, string accept = default(string), int operationIndex = 0);
        ...
        /// <param name="accept">Desired response content type. Defaults to &#x60;application/json&#x60;. (optional, default to application/json)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PostPaymentDetails200Response</returns>
        ApiResponse<PostPaymentDetails200Response> PostPaymentDetailsWithHttpInfo(string firmId, PaymentDetailsRequest paymentDetailsRequest, string accept = default(string), int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="paymentDetailsRequest"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PostPaymentDetailsBulk200Response</returns>
        PostPaymentDetailsBulk200Response PostPaymentDetailsBulk(string firmId, List<PaymentDetailsRequest> paymentDetailsRequest, int operationIndex = 0);
        ...
        /// <param name="paymentDetailsRequest"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PostPaymentDetailsBulk200Response</returns>
        ApiResponse<PostPaymentDetailsBulk200Response> PostPaymentDetailsBulkWithHttpInfo(string firmId, List<PaymentDetailsRequest> paymentDetailsRequest, int operationIndex = 0);
        /// <summary>
        ...
        /// <param name="firmId"></param>
        /// <param name="updateArtifactRedirectURLRequest"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ArtifactResponse</returns>
        ArtifactResponse UpdateArtifactRedirectURL(Guid artifactId, Guid firmId, UpdateArtifactRedirectURLRequest updateArtifactRedirectURLRequest, int operationIndex = 0);
        ...
        ApiResponse<ArtifactResponse> UpdateArtifactRedirectURLWithHttpInfo(Guid artifactId, Guid firmId, UpdateArtifactRedirectURLRequest updateArtifactRedirectURLRequest, int operationIndex = 0);
    ...
    public interface IPaymentsApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FirmArtifactSummary</returns>
        [Obsolete]
        System.Threading.Tasks.Task<FirmArtifactSummary> GetArtifactByFirmExternalIDAndPaymentReferenceNumberAsync(string externalFirmId, string feewisePaymentReferenceNumber, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FirmArtifactSummary)</returns>
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<FirmArtifactSummary>> GetArtifactByFirmExternalIDAndPaymentReferenceNumberWithHttpInfoAsync(string externalFirmId, string feewisePaymentReferenceNumber, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get a firm&#39;s artifacts by its external ID
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of FirmArtifactsResponse</returns>
        [Obsolete]
        System.Threading.Tasks.Task<FirmArtifactsResponse> GetArtifactsByFirmExternalIDAsync(string externalFirmId, DateTime? updatedFrom = default(DateTime?), DateTime? updatedTo = default(DateTime?), List<ArtifactType> artifactTypes = default(List<ArtifactType>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (FirmArtifactsResponse)</returns>
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<FirmArtifactsResponse>> GetArtifactsByFirmExternalIDWithHttpInfoAsync(string externalFirmId, DateTime? updatedFrom = default(DateTime?), DateTime? updatedTo = default(DateTime?), List<ArtifactType> artifactTypes = default(List<ArtifactType>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// DEPRECATED use /transactions - Search for payments for the channel partner
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PostPaymentDetails200Response</returns>
        System.Threading.Tasks.Task<PostPaymentDetails200Response> PostPaymentDetailsAsync(string firmId, PaymentDetailsRequest paymentDetailsRequest, string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PostPaymentDetails200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<PostPaymentDetails200Response>> PostPaymentDetailsWithHttpInfoAsync(string firmId, PaymentDetailsRequest paymentDetailsRequest, string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Retrieve payment details for multiple matters, debtors, invoices or trust requests in bulk.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PostPaymentDetailsBulk200Response</returns>
        System.Threading.Tasks.Task<PostPaymentDetailsBulk200Response> PostPaymentDetailsBulkAsync(string firmId, List<PaymentDetailsRequest> paymentDetailsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PostPaymentDetailsBulk200Response)</returns>
        System.Threading.Tasks.Task<ApiResponse<PostPaymentDetailsBulk200Response>> PostPaymentDetailsBulkWithHttpInfoAsync(string firmId, List<PaymentDetailsRequest> paymentDetailsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Record external payment.
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ArtifactResponse> UpdateArtifactRedirectURLAsync(Guid artifactId, Guid firmId, UpdateArtifactRedirectURLRequest updateArtifactRedirectURLRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<ArtifactResponse>> UpdateArtifactRedirectURLWithHttpInfoAsync(Guid artifactId, Guid firmId, UpdateArtifactRedirectURLRequest updateArtifactRedirectURLRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        public FeeWise.Client.ApiResponse<InvoiceResponse> CreateInvoiceWithHttpInfo(Invoice invoice, string sourceId = default(string), int operationIndex = 0)
        {
            ...
            // authentication (FirmApiKey) required
            if (!string.IsNullOrEmpty(this.Configuration.GetApiKeyWithPrefix("X-FIRM-API-KEY")))
            {
                localVarRequestOptions.HeaderParameters.Add("X-FIRM-API-KEY", this.Configuration.GetApiKeyWithPrefix("X-FIRM-API-KEY"));
            }
        ...
        /// <summary>
        /// Get a firm&#39;s artifact by its FeeWise payment reference number Internal-use endpoint for retrieving artifacts belonging to a firm identified by the partner&#39;s external firm ID &amp; the FeeWise payment reference number.
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="externalFirmId">The ID of the firm in the partner&#39;s system.</param>
        /// <param name="feewisePaymentReferenceNumber">The FeeWise payment reference number of the artifact.</param>
        ...
        /// <returns>FirmArtifactSummary</returns>
        [Obsolete]
        public FirmArtifactSummary GetArtifactByFirmExternalIDAndPaymentReferenceNumber(string externalFirmId, string feewisePaymentReferenceNumber, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<FirmArtifactSummary> localVarResponse = GetArtifactByFirmExternalIDAndPaymentReferenceNumberWithHttpInfo(externalFirmId, feewisePaymentReferenceNumber);
            return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of FirmArtifactSummary</returns>
        [Obsolete]
        public FeeWise.Client.ApiResponse<FirmArtifactSummary> GetArtifactByFirmExternalIDAndPaymentReferenceNumberWithHttpInfo(string externalFirmId, string feewisePaymentReferenceNumber, int operationIndex = 0)
        {
            // verify the required parameter 'externalFirmId' is set
            if (externalFirmId == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'externalFirmId' when calling PaymentsApi->GetArtifactByFirmExternalIDAndPaymentReferenceNumber");
            }

            // verify the required parameter 'feewisePaymentReferenceNumber' is set
            if (feewisePaymentReferenceNumber == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'feewisePaymentReferenceNumber' when calling PaymentsApi->GetArtifactByFirmExternalIDAndPaymentReferenceNumber");
            }
            ...
            localVarRequestOptions.PathParameters.Add("external_firm_id", FeeWise.Client.ClientUtils.ParameterToString(externalFirmId)); // path parameter
            localVarRequestOptions.PathParameters.Add("feewise_payment_reference_number", FeeWise.Client.ClientUtils.ParameterToString(feewisePaymentReferenceNumber)); // path parameter

            localVarRequestOptions.Operation = "PaymentsApi.GetArtifactByFirmExternalIDAndPaymentReferenceNumber";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FirmArtifactSummary>("/api/v3/partner/firms/external/{external_firm_id}/artifacts/{feewise_payment_reference_number}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetArtifactByFirmExternalIDAndPaymentReferenceNumber", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <returns>Task of FirmArtifactSummary</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<FirmArtifactSummary> GetArtifactByFirmExternalIDAndPaymentReferenceNumberAsync(string externalFirmId, string feewisePaymentReferenceNumber, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<FirmArtifactSummary> localVarResponse = await GetArtifactByFirmExternalIDAndPaymentReferenceNumberWithHttpInfoAsync(externalFirmId, feewisePaymentReferenceNumber, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>Task of ApiResponse (FirmArtifactSummary)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<FirmArtifactSummary>> GetArtifactByFirmExternalIDAndPaymentReferenceNumberWithHttpInfoAsync(string externalFirmId, string feewisePaymentReferenceNumber, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'externalFirmId' is set
            if (externalFirmId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<FirmArtifactSummary>("/api/v3/partner/firms/external/{external_firm_id}/artifacts/{feewise_payment_reference_number}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Get a firm&#39;s artifacts by its external ID Internal-use endpoint for retrieving artifacts belonging to a firm identified by the partner&#39;s external ID.
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="externalFirmId">The ID of the firm in the partner&#39;s system.</param>
        /// <param name="updatedFrom">Return artifacts (invoices, trust deposits, etc...) updated at or after this timestamp. (optional)</param>
        ...
        /// <returns>FirmArtifactsResponse</returns>
        [Obsolete]
        public FirmArtifactsResponse GetArtifactsByFirmExternalID(string externalFirmId, DateTime? updatedFrom = default(DateTime?), DateTime? updatedTo = default(DateTime?), List<ArtifactType> artifactTypes = default(List<ArtifactType>), int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<FirmArtifactsResponse> localVarResponse = GetArtifactsByFirmExternalIDWithHttpInfo(externalFirmId, updatedFrom, updatedTo, artifactTypes);
            return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of FirmArtifactsResponse</returns>
        [Obsolete]
        public FeeWise.Client.ApiResponse<FirmArtifactsResponse> GetArtifactsByFirmExternalIDWithHttpInfo(string externalFirmId, DateTime? updatedFrom = default(DateTime?), DateTime? updatedTo = default(DateTime?), List<ArtifactType> artifactTypes = default(List<ArtifactType>), int operationIndex = 0)
        {
            // verify the required parameter 'externalFirmId' is set
            if (externalFirmId == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'externalFirmId' when calling PaymentsApi->GetArtifactsByFirmExternalID");
            }
            ...
            if (updatedFrom != null)
            {
                localVarRequestOptions.QueryParameters.Add(FeeWise.Client.ClientUtils.ParameterToMultiMap("", "updated_from", updatedFrom));
            }
            if (updatedTo != null)
            {
                localVarRequestOptions.QueryParameters.Add(FeeWise.Client.ClientUtils.ParameterToMultiMap("", "updated_to", updatedTo));
            }
            if (artifactTypes != null)
            {
                localVarRequestOptions.QueryParameters.Add(FeeWise.Client.ClientUtils.ParameterToMultiMap("csv", "artifact_types", artifactTypes));
            }

            localVarRequestOptions.Operation = "PaymentsApi.GetArtifactsByFirmExternalID";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<FirmArtifactsResponse>("/api/v3/partner/firms/external/{external_firm_id}/artifacts", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetArtifactsByFirmExternalID", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <returns>Task of FirmArtifactsResponse</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<FirmArtifactsResponse> GetArtifactsByFirmExternalIDAsync(string externalFirmId, DateTime? updatedFrom = default(DateTime?), DateTime? updatedTo = default(DateTime?), List<ArtifactType> artifactTypes = default(List<ArtifactType>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<FirmArtifactsResponse> localVarResponse = await GetArtifactsByFirmExternalIDWithHttpInfoAsync(externalFirmId, updatedFrom, updatedTo, artifactTypes, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>Task of ApiResponse (FirmArtifactsResponse)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<FirmArtifactsResponse>> GetArtifactsByFirmExternalIDWithHttpInfoAsync(string externalFirmId, DateTime? updatedFrom = default(DateTime?), DateTime? updatedTo = default(DateTime?), List<ArtifactType> artifactTypes = default(List<ArtifactType>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'externalFirmId' is set
            if (externalFirmId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<FirmArtifactsResponse>("/api/v3/partner/firms/external/{external_firm_id}/artifacts", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve the payment details for a matter, debtor, invoice or trust request. Generates and returns the payment details for a single item.  The response format is determined by the &#x60;Accept&#x60; request header:   - &#x60;Accept: application/json&#x60; (default) returns a structured JSON     payload containing the payment URL, QR code and the rendered footer     HTML (base64-encoded) as a property of the json.   - &#x60;Accept: text/html&#x60; is a convenience that returns the fully-rendered     footer HTML directly as the response body (no base64). 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="firmId">Can be internal FeeWise ID or Partners Firm ID</param>
        /// <param name="paymentDetailsRequest"></param>
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PostPaymentDetails200Response</returns>
        public PostPaymentDetails200Response PostPaymentDetails(string firmId, PaymentDetailsRequest paymentDetailsRequest, string accept = default(string), int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<PostPaymentDetails200Response> localVarResponse = PostPaymentDetailsWithHttpInfo(firmId, paymentDetailsRequest, accept);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PostPaymentDetails200Response</returns>
        public FeeWise.Client.ApiResponse<PostPaymentDetails200Response> PostPaymentDetailsWithHttpInfo(string firmId, PaymentDetailsRequest paymentDetailsRequest, string accept = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'firmId' is set
            if (firmId == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'firmId' when calling PaymentsApi->PostPaymentDetails");
            }

            // verify the required parameter 'paymentDetailsRequest' is set
            if (paymentDetailsRequest == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'paymentDetailsRequest' when calling PaymentsApi->PostPaymentDetails");
            }
            ...
            if (accept != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept", FeeWise.Client.ClientUtils.ParameterToString(accept)); // header parameter
            }
            localVarRequestOptions.Data = paymentDetailsRequest;

            localVarRequestOptions.Operation = "PaymentsApi.PostPaymentDetails";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<PostPaymentDetails200Response>("/api/v3/partner/firms/{firm_id}/payment/details", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostPaymentDetails", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PostPaymentDetails200Response</returns>
        public async System.Threading.Tasks.Task<PostPaymentDetails200Response> PostPaymentDetailsAsync(string firmId, PaymentDetailsRequest paymentDetailsRequest, string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<PostPaymentDetails200Response> localVarResponse = await PostPaymentDetailsWithHttpInfoAsync(firmId, paymentDetailsRequest, accept, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PostPaymentDetails200Response)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<PostPaymentDetails200Response>> PostPaymentDetailsWithHttpInfoAsync(string firmId, PaymentDetailsRequest paymentDetailsRequest, string accept = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'firmId' is set
            if (firmId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<PostPaymentDetails200Response>("/api/v3/partner/firms/{firm_id}/payment/details", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <summary>
        /// Retrieve payment details for multiple matters, debtors, invoices or trust requests in bulk. Generates and returns payment details for multiple items in a single request.  Always returns a structured JSON payload. Each item contains the payment URL, QR code and the rendered footer HTML (base64-encoded). This mirrors the single endpoint&#39;s &#x60;application/json&#x60; response; there is no &#x60;text/html&#x60; mode for bulk. 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="firmId">Can be internal FeeWise ID or Partners Firm ID</param>
        /// <param name="paymentDetailsRequest"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>PostPaymentDetailsBulk200Response</returns>
        public PostPaymentDetailsBulk200Response PostPaymentDetailsBulk(string firmId, List<PaymentDetailsRequest> paymentDetailsRequest, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<PostPaymentDetailsBulk200Response> localVarResponse = PostPaymentDetailsBulkWithHttpInfo(firmId, paymentDetailsRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PostPaymentDetailsBulk200Response</returns>
        public FeeWise.Client.ApiResponse<PostPaymentDetailsBulk200Response> PostPaymentDetailsBulkWithHttpInfo(string firmId, List<PaymentDetailsRequest> paymentDetailsRequest, int operationIndex = 0)
        {
            // verify the required parameter 'firmId' is set
            if (firmId == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'firmId' when calling PaymentsApi->PostPaymentDetailsBulk");
            }

            // verify the required parameter 'paymentDetailsRequest' is set
            if (paymentDetailsRequest == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'paymentDetailsRequest' when calling PaymentsApi->PostPaymentDetailsBulk");
            }
            ...
            localVarRequestOptions.Operation = "PaymentsApi.PostPaymentDetailsBulk";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<PostPaymentDetailsBulk200Response>("/api/v3/partner/firms/{firm_id}/payment/details/bulk", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PostPaymentDetailsBulk", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PostPaymentDetailsBulk200Response</returns>
        public async System.Threading.Tasks.Task<PostPaymentDetailsBulk200Response> PostPaymentDetailsBulkAsync(string firmId, List<PaymentDetailsRequest> paymentDetailsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<PostPaymentDetailsBulk200Response> localVarResponse = await PostPaymentDetailsBulkWithHttpInfoAsync(firmId, paymentDetailsRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PostPaymentDetailsBulk200Response)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<PostPaymentDetailsBulk200Response>> PostPaymentDetailsBulkWithHttpInfoAsync(string firmId, List<PaymentDetailsRequest> paymentDetailsRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'firmId' is set
            if (firmId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<PostPaymentDetailsBulk200Response>("/api/v3/partner/firms/{firm_id}/payment/details/bulk", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ArtifactResponse</returns>
        public ArtifactResponse UpdateArtifactRedirectURL(Guid artifactId, Guid firmId, UpdateArtifactRedirectURLRequest updateArtifactRedirectURLRequest, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<ArtifactResponse> localVarResponse = UpdateArtifactRedirectURLWithHttpInfo(artifactId, firmId, updateArtifactRedirectURLRequest);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ArtifactResponse</returns>
        public FeeWise.Client.ApiResponse<ArtifactResponse> UpdateArtifactRedirectURLWithHttpInfo(Guid artifactId, Guid firmId, UpdateArtifactRedirectURLRequest updateArtifactRedirectURLRequest, int operationIndex = 0)
        {
            // verify the required parameter 'updateArtifactRedirectURLRequest' is set
            if (updateArtifactRedirectURLRequest == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'updateArtifactRedirectURLRequest' when calling PaymentsApi->UpdateArtifactRedirectURL");
            }
            ...
            localVarRequestOptions.PathParameters.Add("firm_id", FeeWise.Client.ClientUtils.ParameterToString(firmId)); // path parameter
            localVarRequestOptions.Data = updateArtifactRedirectURLRequest;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ArtifactResponse</returns>
        public async System.Threading.Tasks.Task<ArtifactResponse> UpdateArtifactRedirectURLAsync(Guid artifactId, Guid firmId, UpdateArtifactRedirectURLRequest updateArtifactRedirectURLRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<ArtifactResponse> localVarResponse = await UpdateArtifactRedirectURLWithHttpInfoAsync(artifactId, firmId, updateArtifactRedirectURLRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ArtifactResponse)</returns>
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<ArtifactResponse>> UpdateArtifactRedirectURLWithHttpInfoAsync(Guid artifactId, Guid firmId, UpdateArtifactRedirectURLRequest updateArtifactRedirectURLRequest, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'updateArtifactRedirectURLRequest' is set
            if (updateArtifactRedirectURLRequest == null)
            {
