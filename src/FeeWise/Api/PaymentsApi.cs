...
namespace FeeWise.Api
{
    ...
    public interface IPaymentsApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="externalDebtorId"></param>
        /// <param name="externalMatterId"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>GetExternalDebtorMatterStatement200Response</returns>
        [Obsolete]
        GetExternalDebtorMatterStatement200Response GetExternalDebtorMatterStatement(string externalDebtorId, string externalMatterId, int operationIndex = 0);
        ...
        /// <param name="externalMatterId"></param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of GetExternalDebtorMatterStatement200Response</returns>
        [Obsolete]
        ApiResponse<GetExternalDebtorMatterStatement200Response> GetExternalDebtorMatterStatementWithHttpInfo(string externalDebtorId, string externalMatterId, int operationIndex = 0);
        /// <summary>
    ...
    public interface IPaymentsApiAsync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of GetExternalDebtorMatterStatement200Response</returns>
        [Obsolete]
        System.Threading.Tasks.Task<GetExternalDebtorMatterStatement200Response> GetExternalDebtorMatterStatementAsync(string externalDebtorId, string externalMatterId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (GetExternalDebtorMatterStatement200Response)</returns>
        [Obsolete]
        System.Threading.Tasks.Task<ApiResponse<GetExternalDebtorMatterStatement200Response>> GetExternalDebtorMatterStatementWithHttpInfoAsync(string externalDebtorId, string externalMatterId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get invoice by external_id
        /// </summary>
        /// <remarks>
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <summary>
        /// Get a matter debtor statement Get a matter statement that is payable by the client via the returned URL.  External IDs (Provided by the channel partner at invoice creation are used for the retrieval.) Deprecated The preferred approach is to use /api/v3/partner/statements/debtors/{debtor_id}/matters/{matter_id}. The preferred approach guarantees uniqueness in debtor and matter ID, as they are created by FeeWise. nb: Since external IDs are created outside of FeeWise, there&#39;s no way for FeeWise to guarantee that an external ID  is unique within FeeWise, therefore, this endpoint response will return an array of items. If the calling partner is  confident that the external ID used is unique, there should only be a single item in the array. 
        /// </summary>
        /// <exception cref="FeeWise.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="externalDebtorId"></param>
        /// <param name="externalMatterId"></param>
        ...
        /// <returns>GetExternalDebtorMatterStatement200Response</returns>
        [Obsolete]
        public GetExternalDebtorMatterStatement200Response GetExternalDebtorMatterStatement(string externalDebtorId, string externalMatterId, int operationIndex = 0)
        {
            FeeWise.Client.ApiResponse<GetExternalDebtorMatterStatement200Response> localVarResponse = GetExternalDebtorMatterStatementWithHttpInfo(externalDebtorId, externalMatterId);
            return localVarResponse.Data;
        }
        ...
        /// <returns>ApiResponse of GetExternalDebtorMatterStatement200Response</returns>
        [Obsolete]
        public FeeWise.Client.ApiResponse<GetExternalDebtorMatterStatement200Response> GetExternalDebtorMatterStatementWithHttpInfo(string externalDebtorId, string externalMatterId, int operationIndex = 0)
        {
            // verify the required parameter 'externalDebtorId' is set
            if (externalDebtorId == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'externalDebtorId' when calling PaymentsApi->GetExternalDebtorMatterStatement");
            }

            // verify the required parameter 'externalMatterId' is set
            if (externalMatterId == null)
            {
                throw new FeeWise.Client.ApiException(400, "Missing required parameter 'externalMatterId' when calling PaymentsApi->GetExternalDebtorMatterStatement");
            }
            ...
            localVarRequestOptions.PathParameters.Add("external_debtor_id", FeeWise.Client.ClientUtils.ParameterToString(externalDebtorId)); // path parameter
            localVarRequestOptions.PathParameters.Add("external_matter_id", FeeWise.Client.ClientUtils.ParameterToString(externalMatterId)); // path parameter

            localVarRequestOptions.Operation = "PaymentsApi.GetExternalDebtorMatterStatement";
            localVarRequestOptions.OperationIndex = operationIndex;
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<GetExternalDebtorMatterStatement200Response>("/api/v3/partner/statements/external/debtors/{external_debtor_id}/matters/{external_matter_id}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("GetExternalDebtorMatterStatement", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        /// <returns>Task of GetExternalDebtorMatterStatement200Response</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<GetExternalDebtorMatterStatement200Response> GetExternalDebtorMatterStatementAsync(string externalDebtorId, string externalMatterId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            FeeWise.Client.ApiResponse<GetExternalDebtorMatterStatement200Response> localVarResponse = await GetExternalDebtorMatterStatementWithHttpInfoAsync(externalDebtorId, externalMatterId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>Task of ApiResponse (GetExternalDebtorMatterStatement200Response)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<FeeWise.Client.ApiResponse<GetExternalDebtorMatterStatement200Response>> GetExternalDebtorMatterStatementWithHttpInfoAsync(string externalDebtorId, string externalMatterId, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'externalDebtorId' is set
            if (externalDebtorId == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<GetExternalDebtorMatterStatement200Response>("/api/v3/partner/statements/external/debtors/{external_debtor_id}/matters/{external_matter_id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
