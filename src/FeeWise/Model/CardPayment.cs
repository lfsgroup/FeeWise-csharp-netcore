...
namespace FeeWise.Model
{
    ...
    public partial class CardPayment : IEquatable<CardPayment>, IValidatableObject
    {
        ...
        public CardPayment(string scheme = default(string), string schemePartialNumber = default(string), string fundingType = default(string), string country = default(string))
        {
            this.Scheme = scheme;
