...
namespace FeeWise.Model
{
    ...
    public partial class ExternalPayment : IEquatable<ExternalPayment>, IValidatableObject
    {
        ...
        /// <param name="externalId">An ID, external to FeeWise, to identify the payment.</param>
        /// <param name="details">Freeform description of the payment (eg \&quot;Paid in person with cash - receipt GB-6832\&quot; ).</param>
        public ExternalPayment(Guid artifactId = default(Guid), ArtifactType artifactType = default(ArtifactType), string amount = default(string), string paymentType = default(string), string externalId = default(string), string details = default(string))
        {
