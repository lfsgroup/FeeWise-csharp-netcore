...
namespace FeeWise.Model
{
    ...
    public partial class CreateFirm : IEquatable<CreateFirm>, IValidatableObject
    {
        ...
        public CreateFirm(FirmDetails firmDetails = default(FirmDetails), Address address = default(Address), CreateFirmOfficeAccount officeAccount = default(CreateFirmOfficeAccount), CreateFirmOfficeAccount trustAccount = default(CreateFirmOfficeAccount), List<Person> roles = default(List<Person>), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
            // to ensure "firmDetails" is required (not null)
            if (firmDetails == null)
            {
                throw new ArgumentNullException("firmDetails is a required property for CreateFirm and cannot be null");
            }
        ...
        public CreateFirmOfficeAccount OfficeAccount { get; set; }

        /// <summary>
        /// Gets or Sets TrustAccount
        /// </summary>
        [DataMember(Name = "trust_account", EmitDefaultValue = false)]
        public CreateFirmOfficeAccount TrustAccount { get; set; }
