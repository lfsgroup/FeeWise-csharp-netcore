...
namespace FeeWise.Model
{
    ...
    public partial class CreateFirm : IEquatable<CreateFirm>, IValidatableObject
    {
        ...
        public CreateFirm(Company company = default(Company), Address address = default(Address), BankAccount officeAccount = default(BankAccount), BankAccount trustAccount = default(BankAccount), RiskAssessment riskAssessment = default(RiskAssessment), List<Person> roles = default(List<Person>), Dictionary<string, string> metadata = default(Dictionary<string, string>), TermsOfService termsOfService = default(TermsOfService))
        {
        ...
        /// </summary>
        [DataMember(Name = "risk_assessment", EmitDefaultValue = false)]
