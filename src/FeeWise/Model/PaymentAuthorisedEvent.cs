...
namespace FeeWise.Model
{
    ...
    public partial class PaymentAuthorisedEvent : IEquatable<PaymentAuthorisedEvent>, IValidatableObject
    {
        ...
        /// <param name="externalFirmId">The firm ID from the partner&#39;s system.</param>
        ...
        public PaymentAuthorisedEvent(List<ArtifactReceipt> artifacts = default(List<ArtifactReceipt>), Guid paymentId = default(Guid), string amountPaid = default(string), CardPayment cardPayment = default(CardPayment), DebitPayment debitPayment = default(DebitPayment), Guid firmId = default(Guid), string externalFirmId = default(string), Guid settlementAccountExternalId = default(Guid), DateTime paymentDate = default(DateTime), string payerName = default(string), PaymentMethod paymentMethod = default(PaymentMethod), string paymentMethodDetail = default(string))
        {
        ...
        [DataMember(Name = "external_firm_id", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>The date the payment was made</value>
