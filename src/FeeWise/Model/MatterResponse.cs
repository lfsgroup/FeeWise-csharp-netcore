...
namespace FeeWise.Model
{
    ...
    /// MatterResponse
    /// </summary>
    [DataContract(Name = "MatterResponse")]
    public partial class MatterResponse : IEquatable<MatterResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MatterResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MatterResponse()
        {
        ...
        public MatterResponse(Guid firmId = default(Guid), Matter matter = default(Matter), Debtor debtor = default(Debtor), List<Artifact> artifacts = default(List<Artifact>))
        {
            this.FirmId = firmId;
            // to ensure "matter" is required (not null)
            if (matter == null)
            {
                throw new ArgumentNullException("matter is a required property for MatterResponse and cannot be null");
            }
            this.Matter = matter;
            // to ensure "artifacts" is required (not null)
            if (artifacts == null)
            {
                throw new ArgumentNullException("artifacts is a required property for MatterResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MatterResponse {\n");
        ...
        {
            return this.Equals(input as MatterResponse);
        }

        /// <summary>
        /// Returns true if MatterResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MatterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MatterResponse input)
        {
            if (input == null)
            {
                return false;
