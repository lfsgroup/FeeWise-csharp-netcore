...
namespace FeeWise.Model
{
    ...
    public partial class ArtifactReceiptAccount : IEquatable<ArtifactReceiptAccount>, IValidatableObject
    {
        ...
        /// <param name="externalId">The external ID of the account.</param>
        public ArtifactReceiptAccount(AccountType accountType = default(AccountType), string branchCode = default(string), string accountNumber = default(string), Guid accountId = default(Guid), string alias = default(string), string countryCode = default(string), string externalId = default(string))
        {
        ...
        /// </summary>
        /// <value>The external ID of the account</value>
