...
namespace FeeWise.Model
{
    ...
    public partial class Person : IEquatable<Person>, IValidatableObject
    {
        ...
        /// <param name="nationalId">This field may be required to be populated, depending on the region.  For the US , this is the social security number, and is required. For CA, this is the social insurance number. For AU, this is the tax file number or driving licence number. For UK, this is the national insurance number. .</param>
        ...
        /// <param name="isDirector">Indicates if the individual is a director of the organization. Directors are typically members of the governing board of the company..</param>
        ...
        /// <summary>
        /// This field may be required to be populated, depending on the region.  For the US , this is the social security number, and is required. For CA, this is the social insurance number. For AU, this is the tax file number or driving licence number. For UK, this is the national insurance number. 
        /// </summary>
        /// <value>This field may be required to be populated, depending on the region.  For the US , this is the social security number, and is required. For CA, this is the social insurance number. For AU, this is the tax file number or driving licence number. For UK, this is the national insurance number. </value>
        ...
        /// <summary>
        /// Indicates if the individual is a director of the organization. Directors are typically members of the governing board of the company.
        /// </summary>
        /// <value>Indicates if the individual is a director of the organization. Directors are typically members of the governing board of the company.</value>
        [DataMember(Name = "is_director", EmitDefaultValue = true)]
