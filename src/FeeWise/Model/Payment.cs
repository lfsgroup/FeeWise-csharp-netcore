...
namespace FeeWise.Model
{
    ...
    public partial class Payment : IEquatable<Payment>, IValidatableObject
    {
        ...
        public Payment(Guid transactionId = default(Guid), Guid paymentId = default(Guid), PaymentMethod? paymentType = default(PaymentMethod?), Guid artifactId = default(Guid), string reference = default(string), ArtifactType artifactType = default(ArtifactType), string externalId = default(string), PaymentExternalPayment externalPayment = default(PaymentExternalPayment), string received = default(string), string refunded = default(string), string paidOut = default(string), string currency = default(string), DateTime date = default(DateTime), Dictionary<string, string> metadata = default(Dictionary<string, string>))
        {
