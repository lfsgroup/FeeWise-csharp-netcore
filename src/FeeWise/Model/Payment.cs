...
namespace FeeWise.Model
{
    ...
    public partial class Payment : IEquatable<Payment>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Payment" /> class.
        /// </summary>
        /// <param name="paymentId">The unique id of the payment. (required).</param>
        ...
        public Payment(Guid paymentId = default(Guid), PaymentMethod? paymentType = default(PaymentMethod?), Guid artifactId = default(Guid), ArtifactType artifactType = default(ArtifactType), string externalId = default(string), PaymentExternalPayment externalPayment = default(PaymentExternalPayment), string received = default(string), string refunded = default(string), string paidOut = default(string), string currency = default(string), DateTime date = default(DateTime))
        {
