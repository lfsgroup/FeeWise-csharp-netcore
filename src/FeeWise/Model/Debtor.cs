...
namespace FeeWise.Model
{
    ...
    public partial class Debtor : IEquatable<Debtor>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="externalId">ID in the PMS.</param>
        /// <param name="name">name.</param>
        /// <param name="email">email.</param>
        /// <param name="contactNumber">contactNumber.</param>
        public Debtor(string externalId = default(string), string name = default(string), string email = default(string), string contactNumber = default(string))
        {
