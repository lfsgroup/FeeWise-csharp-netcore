...
namespace FeeWise.Model
{
    ...
    public partial class Debtor : IEquatable<Debtor>, IValidatableObject
    {
        ...
        public Debtor(Guid debtorId = default(Guid), string externalId = default(string), string name = default(string), string firstName = default(string), string lastName = default(string), string email = default(string), string contactNumber = default(string))
        {
