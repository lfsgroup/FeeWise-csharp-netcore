...
namespace FeeWise.Model
{
    ...
    public partial class Payout : IEquatable<Payout>, IValidatableObject
    {
        ...
        /// <param name="receiptIds">Receipt IDs from the partner system that associate the payments in this event to the partner artifacts (invoices, trust deposits, etc...) .</param>
