...
namespace FeeWise.Model
{
    ...
    public partial class Payout : IEquatable<Payout>, IValidatableObject
    {
        ...
        public Payout(string payoutReference = default(string), DateTime date = default(DateTime), string payoutTotal = default(string), PayoutAccount account = default(PayoutAccount), Guid firmId = default(Guid), List<Payment> transactions = default(List<Payment>))
        {
