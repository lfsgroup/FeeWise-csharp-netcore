...
namespace FeeWise.Model
{
    ...
    public partial class WebhookEventEvent : AbstractOpenAPISchema, IEquatable<WebhookEventEvent>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventEvent" /> class
        /// with the <see cref="FirmBankAccountUpdatedEvent" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of FirmBankAccountUpdatedEvent.</param>
        public WebhookEventEvent(FirmBankAccountUpdatedEvent actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(FirmBankAccountUpdatedEvent))
                {
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: FirmBankAccountUpdatedEvent, FirmStatusUpdatedEvent, Invoice, Payment, PaymentAuthorisedEvent, PaymentNotificationEvent, Payout, TrustDeposit");
                }
            }
        }
        ...
        /// <summary>
        /// Get the actual instance of `FirmBankAccountUpdatedEvent`. If the actual instance is not `FirmBankAccountUpdatedEvent`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of FirmBankAccountUpdatedEvent</returns>
        public FirmBankAccountUpdatedEvent GetFirmBankAccountUpdatedEvent()
        {
            return (FirmBankAccountUpdatedEvent)this.ActualInstance;
        }
        ...
        public static WebhookEventEvent FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                if (typeof(FirmBankAccountUpdatedEvent).GetProperty("AdditionalProperties") == null)
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmBankAccountUpdatedEvent>(jsonString, WebhookEventEvent.SerializerSettings));
                }
                else
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmBankAccountUpdatedEvent>(jsonString, WebhookEventEvent.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("FirmBankAccountUpdatedEvent");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into FirmBankAccountUpdatedEvent: {1}", jsonString, exception.ToString()));
            }
