...
namespace FeeWise.Model
{
    ...
    public partial class WebhookEventEvent : AbstractOpenAPISchema, IEquatable<WebhookEventEvent>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventEvent" /> class
        /// with the <see cref="FirmBankAccountEvent" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of FirmBankAccountEvent.</param>
        public WebhookEventEvent(FirmBankAccountEvent actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventEvent" /> class
        /// with the <see cref="FirmSurchargeSettingsEvent" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of FirmSurchargeSettingsEvent.</param>
        public WebhookEventEvent(FirmSurchargeSettingsEvent actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventEvent" /> class
        /// with the <see cref="FirmPricingUpdatedEvent" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of FirmPricingUpdatedEvent.</param>
        public WebhookEventEvent(FirmPricingUpdatedEvent actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventEvent" /> class
        /// with the <see cref="FirmAffiliationCreatedEvent" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of FirmAffiliationCreatedEvent.</param>
        public WebhookEventEvent(FirmAffiliationCreatedEvent actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventEvent" /> class
        /// with the <see cref="MatterBankDepositSyncEvent" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of MatterBankDepositSyncEvent.</param>
        public WebhookEventEvent(MatterBankDepositSyncEvent actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventEvent" /> class
        /// with the <see cref="MatterReceiptSyncEvent" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of MatterReceiptSyncEvent.</param>
        public WebhookEventEvent(MatterReceiptSyncEvent actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(FirmAffiliationCreatedEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(FirmBankAccountEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(FirmPricingUpdatedEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(FirmStatusUpdatedEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(FirmSurchargeSettingsEvent))
                {
                    this._actualInstance = value;
                }
                ...
                else if (value.GetType() == typeof(MatterBankDepositSyncEvent))
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(MatterReceiptSyncEvent))
                {
                    this._actualInstance = value;
                }
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: FirmAffiliationCreatedEvent, FirmBankAccountEvent, FirmPricingUpdatedEvent, FirmStatusUpdatedEvent, FirmSurchargeSettingsEvent, Invoice, MatterBankDepositSyncEvent, MatterReceiptSyncEvent, Payment, PaymentAuthorisedEvent, PaymentNotificationEvent, Payout, TrustDeposit");
                }
            }
        }
        ...
        /// <summary>
        /// Get the actual instance of `FirmBankAccountEvent`. If the actual instance is not `FirmBankAccountEvent`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of FirmBankAccountEvent</returns>
        public FirmBankAccountEvent GetFirmBankAccountEvent()
        {
            return (FirmBankAccountEvent)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `FirmSurchargeSettingsEvent`. If the actual instance is not `FirmSurchargeSettingsEvent`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of FirmSurchargeSettingsEvent</returns>
        public FirmSurchargeSettingsEvent GetFirmSurchargeSettingsEvent()
        {
            return (FirmSurchargeSettingsEvent)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `FirmPricingUpdatedEvent`. If the actual instance is not `FirmPricingUpdatedEvent`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of FirmPricingUpdatedEvent</returns>
        public FirmPricingUpdatedEvent GetFirmPricingUpdatedEvent()
        {
            return (FirmPricingUpdatedEvent)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `FirmAffiliationCreatedEvent`. If the actual instance is not `FirmAffiliationCreatedEvent`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of FirmAffiliationCreatedEvent</returns>
        public FirmAffiliationCreatedEvent GetFirmAffiliationCreatedEvent()
        {
            return (FirmAffiliationCreatedEvent)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `MatterBankDepositSyncEvent`. If the actual instance is not `MatterBankDepositSyncEvent`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of MatterBankDepositSyncEvent</returns>
        public MatterBankDepositSyncEvent GetMatterBankDepositSyncEvent()
        {
            return (MatterBankDepositSyncEvent)this.ActualInstance;
        }

        /// <summary>
        /// Get the actual instance of `MatterReceiptSyncEvent`. If the actual instance is not `MatterReceiptSyncEvent`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of MatterReceiptSyncEvent</returns>
        public MatterReceiptSyncEvent GetMatterReceiptSyncEvent()
        {
            return (MatterReceiptSyncEvent)this.ActualInstance;
        }
        ...
        public static WebhookEventEvent FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                if (typeof(FirmAffiliationCreatedEvent).GetProperty("AdditionalProperties") == null)
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmAffiliationCreatedEvent>(jsonString, WebhookEventEvent.SerializerSettings));
                }
                else
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmAffiliationCreatedEvent>(jsonString, WebhookEventEvent.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("FirmAffiliationCreatedEvent");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into FirmAffiliationCreatedEvent: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(FirmBankAccountEvent).GetProperty("AdditionalProperties") == null)
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmBankAccountEvent>(jsonString, WebhookEventEvent.SerializerSettings));
                }
                else
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmBankAccountEvent>(jsonString, WebhookEventEvent.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("FirmBankAccountEvent");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into FirmBankAccountEvent: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(FirmPricingUpdatedEvent).GetProperty("AdditionalProperties") == null)
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmPricingUpdatedEvent>(jsonString, WebhookEventEvent.SerializerSettings));
                }
                else
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmPricingUpdatedEvent>(jsonString, WebhookEventEvent.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("FirmPricingUpdatedEvent");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into FirmPricingUpdatedEvent: {1}", jsonString, exception.ToString()));
            }
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(FirmSurchargeSettingsEvent).GetProperty("AdditionalProperties") == null)
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmSurchargeSettingsEvent>(jsonString, WebhookEventEvent.SerializerSettings));
                }
                else
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<FirmSurchargeSettingsEvent>(jsonString, WebhookEventEvent.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("FirmSurchargeSettingsEvent");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into FirmSurchargeSettingsEvent: {1}", jsonString, exception.ToString()));
            }
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(MatterBankDepositSyncEvent).GetProperty("AdditionalProperties") == null)
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<MatterBankDepositSyncEvent>(jsonString, WebhookEventEvent.SerializerSettings));
                }
                else
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<MatterBankDepositSyncEvent>(jsonString, WebhookEventEvent.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("MatterBankDepositSyncEvent");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into MatterBankDepositSyncEvent: {1}", jsonString, exception.ToString()));
            }

            try
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(MatterReceiptSyncEvent).GetProperty("AdditionalProperties") == null)
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<MatterReceiptSyncEvent>(jsonString, WebhookEventEvent.SerializerSettings));
                }
                else
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<MatterReceiptSyncEvent>(jsonString, WebhookEventEvent.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("MatterReceiptSyncEvent");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into MatterReceiptSyncEvent: {1}", jsonString, exception.ToString()));
            }
