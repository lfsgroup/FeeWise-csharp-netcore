...
namespace FeeWise.Model
{
    ...
    public partial class WebhookEventEvent : AbstractOpenAPISchema, IEquatable<WebhookEventEvent>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookEventEvent" /> class
        /// with the <see cref="MatterPaymentReceiptEvent" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of MatterPaymentReceiptEvent.</param>
        public WebhookEventEvent(MatterPaymentReceiptEvent actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                ...
                else if (value.GetType() == typeof(MatterPaymentReceiptEvent))
                {
                    this._actualInstance = value;
                }
                ...
                {
                    throw new ArgumentException("Invalid instance found. Must be the following types: FirmAffiliationCreatedEvent, FirmBankAccountEvent, FirmPricingUpdatedEvent, FirmStatusUpdatedEvent, FirmSurchargeSettingsEvent, Invoice, MatterPaymentReceiptEvent, Payment, PaymentAuthorisedEvent, PaymentNotificationEvent, Payout, TrustDeposit");
                }
            }
        }
        ...
        /// <summary>
        /// Get the actual instance of `MatterPaymentReceiptEvent`. If the actual instance is not `MatterPaymentReceiptEvent`,
        /// the InvalidClassException will be thrown
        /// </summary>
        /// <returns>An instance of MatterPaymentReceiptEvent</returns>
        public MatterPaymentReceiptEvent GetMatterPaymentReceiptEvent()
        {
            return (MatterPaymentReceiptEvent)this.ActualInstance;
        }
        ...
        public static WebhookEventEvent FromJson(string jsonString)
        {
            ...
            {
                // if it does not contains "AdditionalProperties", use SerializerSettings to deserialize
                if (typeof(MatterPaymentReceiptEvent).GetProperty("AdditionalProperties") == null)
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<MatterPaymentReceiptEvent>(jsonString, WebhookEventEvent.SerializerSettings));
                }
                else
                {
                    newWebhookEventEvent = new WebhookEventEvent(JsonConvert.DeserializeObject<MatterPaymentReceiptEvent>(jsonString, WebhookEventEvent.AdditionalPropertiesSerializerSettings));
                }
                matchedTypes.Add("MatterPaymentReceiptEvent");
                match++;
            }
            catch (Exception exception)
            {
                // deserialization failed, try the next one
                System.Diagnostics.Debug.WriteLine(string.Format("Failed to deserialize `{0}` into MatterPaymentReceiptEvent: {1}", jsonString, exception.ToString()));
            }
