...
namespace FeeWise.Model
{
    ...
    public partial class DebitPayment : IEquatable<DebitPayment>, IValidatableObject
    {
        ...
        public DebitPayment(string country = default(string), string bankName = default(string), string accountName = default(string), string branchCode = default(string), string accountPartialNumber = default(string))
        {
