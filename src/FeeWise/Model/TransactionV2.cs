...
namespace FeeWise.Model
{
    ...
    public partial class TransactionV2 : IEquatable<TransactionV2>, IValidatableObject
    {
        ...
        public TransactionV2(Guid paymentReference = default(Guid), Guid accountId = default(Guid), Guid payoutId = default(Guid), DateTime payoutDate = default(DateTime), string reference = default(string), Debtor debtor = default(Debtor), string matterReference = default(string), string matterDescription = default(string), DateTime paymentDate = default(DateTime), CustomerPaymentMethod customerPaymentMethod = default(CustomerPaymentMethod), string accountAlias = default(string), AccountType accountType = default(AccountType), string amount = default(string), TransactionStatus status = default(TransactionStatus), Payer payerDetails = default(Payer), string clientReference = default(string), Dictionary<string, string> metadata = default(Dictionary<string, string>), string transactionUri = default(string), string fundingType = default(string), bool surcharged = default(bool), string surchargedAmount = default(string), bool refundable = default(bool), Refund refund = default(Refund))
        {
            ...
            {
                throw new ArgumentNullException("accountAlias is a required property for TransactionV2 and cannot be null");
            }
            ...
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for TransactionV2 and cannot be null");
            }
            this.Amount = amount;
            this.Status = status;
        ...
        {
            return this.Equals(input as TransactionV2);
        }
