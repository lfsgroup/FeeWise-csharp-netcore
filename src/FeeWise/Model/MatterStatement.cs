...
namespace FeeWise.Model
{
    ...
    public partial class MatterStatement : IEquatable<MatterStatement>, IValidatableObject
    {
        ...
        public MatterStatement(Matter matter = default(Matter), Guid firmId = default(Guid), Debtor debtor = default(Debtor), List<Artifact> artifacts = default(List<Artifact>), string paymentUrl = default(string), string pdfUrl = default(string))
        {
