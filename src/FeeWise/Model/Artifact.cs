...
namespace FeeWise.Model
{
    ...
    public partial class Artifact : IEquatable<Artifact>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets ArtifactSubtype
        /// </summary>
        [DataMember(Name = "artifact_subtype", EmitDefaultValue = false)]
        public ArtifactSubtype? ArtifactSubtype { get; set; }
        /// <summary>
        ...
        /// <param name="settlementAccountId">The FeeWise id of the bank account the artifact settlement should be paid to.  NB, if both the settlement_account_type and settlement_account_id are specified, it is a bad request .</param>
        /// <param name="settlementAccountExternalId">The id of the account the artifact settlement should be paid to, in the partner&#39;s system..  NB, This property is only for the partners reference, only the settlement_account_id property will be used by FeeWise .</param>
        ...
        /// <param name="artifactSubtype">artifactSubtype.</param>
        /// <param name="createdAt">The date the partner created the artifact..</param>
        /// <param name="sourceId">The source ID that was passed in when creating the artifact..</param>
        /// <param name="paymentRedirectUrl">Optional URL the payer will be redirected to after payment.</param>
        public Artifact(Guid artifactId = default(Guid), ArtifactType artifactType = default(ArtifactType), string externalId = default(string), string externalReference = default(string), string amount = default(string), string amountDue = default(string), Currency? currency = default(Currency?), DateTime dueDate = default(DateTime), AccountType? settlementAccountType = default(AccountType?), Guid settlementAccountId = default(Guid), Guid settlementAccountExternalId = default(Guid), List<LineItem> lineItems = default(List<LineItem>), List<string> notes = default(List<string>), List<Payment> payments = default(List<Payment>), List<PaymentMethod> paymentMethodsOverride = default(List<PaymentMethod>), SurchargeChoice? surchargeChoiceOverride = default(SurchargeChoice?), string description = default(string), StatusEnum? status = default(StatusEnum?), ArtifactSubtype? artifactSubtype = default(ArtifactSubtype?), DateTime createdAt = default(DateTime), string sourceId = default(string), string paymentRedirectUrl = default(string))
        {
            ...
            this.SettlementAccountExternalId = settlementAccountExternalId;
        ...
        /// <summary>
        /// The FeeWise id of the bank account the artifact settlement should be paid to.  NB, if both the settlement_account_type and settlement_account_id are specified, it is a bad request 
        /// </summary>
        /// <value>The FeeWise id of the bank account the artifact settlement should be paid to.  NB, if both the settlement_account_type and settlement_account_id are specified, it is a bad request </value>
        [DataMember(Name = "settlement_account_id", EmitDefaultValue = false)]
        public Guid SettlementAccountId { get; set; }

        /// <summary>
        /// The id of the account the artifact settlement should be paid to, in the partner&#39;s system..  NB, This property is only for the partners reference, only the settlement_account_id property will be used by FeeWise 
        /// </summary>
        ...
        /// <summary>
        /// The date the partner created the artifact.
        /// </summary>
        /// <value>The date the partner created the artifact.</value>
        [DataMember(Name = "created_at", EmitDefaultValue = false)]
        public DateTime CreatedAt { get; set; }

        /// <summary>
        /// The source ID that was passed in when creating the artifact.
        /// </summary>
        /// <value>The source ID that was passed in when creating the artifact.</value>
        [DataMember(Name = "source_id", EmitDefaultValue = false)]
        public string SourceId { get; set; }

        /// <summary>
        /// Optional URL the payer will be redirected to after payment
        /// </summary>
        /// <value>Optional URL the payer will be redirected to after payment</value>
        [DataMember(Name = "payment_redirect_url", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SettlementAccountExternalId: ").Append(SettlementAccountExternalId).Append("\n");
            ...
            sb.Append("  ArtifactSubtype: ").Append(ArtifactSubtype).Append("\n");
        ...
        public bool Equals(Artifact input)
        {
            ...
            return 
                ...
                (
                    this.SettlementAccountExternalId == input.SettlementAccountExternalId ||
                    (this.SettlementAccountExternalId != null &&
                    this.SettlementAccountExternalId.Equals(input.SettlementAccountExternalId))
                ) && 
                (
                ...
                (
                    this.ArtifactSubtype == input.ArtifactSubtype ||
                    this.ArtifactSubtype.Equals(input.ArtifactSubtype)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SettlementAccountExternalId != null)
                {
                    hashCode = (hashCode * 59) + this.SettlementAccountExternalId.GetHashCode();
                }
                ...
                hashCode = (hashCode * 59) + this.ArtifactSubtype.GetHashCode();
