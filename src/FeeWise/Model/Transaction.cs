...
namespace FeeWise.Model
{
    ...
    public partial class Transaction : IEquatable<Transaction>, IValidatableObject
    {
        ...
        public Transaction(Guid paymentReference = default(Guid), Guid accountId = default(Guid), Guid payoutId = default(Guid), string reference = default(string), Debtor debtor = default(Debtor), string matterReference = default(string), string matterDescription = default(string), DateTime paymentDate = default(DateTime), CustomerPaymentMethod customerPaymentMethod = default(CustomerPaymentMethod), string accountAlias = default(string), AccountType accountType = default(AccountType), string amount = default(string), TransactionStatus status = default(TransactionStatus), Payer payerDetails = default(Payer), string clientReference = default(string))
        {
            this.PaymentReference = paymentReference;
            // to ensure "reference" is required (not null)
            if (reference == null)
            {
                throw new ArgumentNullException("reference is a required property for Transaction and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("accountAlias is a required property for Transaction and cannot be null");
            }
            ...
            if (amount == null)
            {
                throw new ArgumentNullException("amount is a required property for Transaction and cannot be null");
            }
            this.Amount = amount;
            this.Status = status;
