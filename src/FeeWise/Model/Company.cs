...
namespace FeeWise.Model
{
    ...
    public partial class Company : IEquatable<Company>, IValidatableObject
    {
        ...
        public Company(Guid firmId = default(Guid), string externalId = default(string), string legalName = default(string), string legalIdentifier = default(string), LegalStructureEnum legalStructure = default(LegalStructureEnum), string taxId = default(string), string tradingName = default(string), string website = default(string), CompanySupportEmail supportEmail = default(CompanySupportEmail), string supportNumber = default(string), string contactEmail = default(string), string contactNumber = default(string), string billingEmail = default(string), string billingNumber = default(string), StatusEnum? status = default(StatusEnum?))
        {
