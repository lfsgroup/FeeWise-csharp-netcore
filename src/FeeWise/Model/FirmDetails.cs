...
namespace FeeWise.Model
{
    ...
    public partial class FirmDetails : IEquatable<FirmDetails>, IValidatableObject
    {
        ...
        /// <param name="status">Firm&#39;s status..</param>
        public FirmDetails(Guid firmId = default(Guid), string externalId = default(string), string legalName = default(string), string legalIdentifier = default(string), LegalStructureEnum legalStructure = default(LegalStructureEnum), string taxId = default(string), string tradingName = default(string), string website = default(string), FirmDetailsSupportEmail supportEmail = default(FirmDetailsSupportEmail), string supportNumber = default(string), string contactEmail = default(string), string contactNumber = default(string), string billingEmail = default(string), string billingNumber = default(string), StatusEnum? status = default(StatusEnum?))
        {
            // to ensure "legalName" is required (not null)
            if (legalName == null)
            {
                throw new ArgumentNullException("legalName is a required property for FirmDetails and cannot be null");
            }
            ...
            if (taxId == null)
            {
                throw new ArgumentNullException("taxId is a required property for FirmDetails and cannot be null");
            }
            this.TaxId = taxId;
            // to ensure "tradingName" is required (not null)
            if (tradingName == null)
            {
                throw new ArgumentNullException("tradingName is a required property for FirmDetails and cannot be null");
            }
            this.TradingName = tradingName;
            // to ensure "website" is required (not null)
            if (website == null)
            {
                throw new ArgumentNullException("website is a required property for FirmDetails and cannot be null");
            }
            this.Website = website;
            // to ensure "contactEmail" is required (not null)
            if (contactEmail == null)
            {
                throw new ArgumentNullException("contactEmail is a required property for FirmDetails and cannot be null");
            }
            this.ContactEmail = contactEmail;
            // to ensure "contactNumber" is required (not null)
            if (contactNumber == null)
            {
                throw new ArgumentNullException("contactNumber is a required property for FirmDetails and cannot be null");
            }
            this.ContactNumber = contactNumber;
            // to ensure "billingEmail" is required (not null)
            if (billingEmail == null)
            {
                throw new ArgumentNullException("billingEmail is a required property for FirmDetails and cannot be null");
            }
        ...
        public FirmDetailsSupportEmail SupportEmail { get; set; }
