...
namespace FeeWise.Model
{
    ...
    public partial class FirmDetails : IEquatable<FirmDetails>, IValidatableObject
    {
        ...
        public FirmDetails(Company company = default(Company), Address address = default(Address), List<BankAccount> accounts = default(List<BankAccount>), List<Person> roles = default(List<Person>), TermsOfService termsOfService = default(TermsOfService), Dictionary<string, string> metadata = default(Dictionary<string, string>), SurchargeSettings surchargeSettings = default(SurchargeSettings))
        {
