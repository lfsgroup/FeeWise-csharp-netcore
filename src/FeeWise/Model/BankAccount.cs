...
namespace FeeWise.Model
{
    ...
    public partial class BankAccount : IEquatable<BankAccount>, IValidatableObject
    {
        ...
        public BankAccount(Guid accountId = default(Guid), AccountType accountType = default(AccountType), string accountName = default(string), string accountNumber = default(string), string branchCode = default(string), string bank = default(string), bool isDefault = default(bool))
        {
