...
namespace FeeWise.Model
{
    ...
    public partial class CustomerPaymentMethod : IEquatable<CustomerPaymentMethod>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="paymentMethodId">The unique ID for this customer&#39;s payment method, this can be used to charge the associated customer.</param>
        ...
        public CustomerPaymentMethod(Guid paymentMethodId = default(Guid), string scheme = default(string), string schemePartialNumber = default(string), string fundingType = default(string), string country = default(string), DateTime expirationDate = default(DateTime))
        {
