...
namespace FeeWise.Model
{
    ...
    public partial class CustomerPaymentMethod : IEquatable<CustomerPaymentMethod>, IValidatableObject
    {
        ...
        public CustomerPaymentMethod(Guid paymentToken = default(Guid), string scheme = default(string), string schemePartialNumber = default(string), string fundingType = default(string), string country = default(string), DateTime expirationDate = default(DateTime))
        {
