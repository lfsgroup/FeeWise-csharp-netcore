...
**SettlementAccountId** | **Guid** | The FeeWise id of the bank account the artifact settlement should be paid to.  NB, if both the settlement_account_type and settlement_account_id are specified, it is a bad request  | [optional] 
