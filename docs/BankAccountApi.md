...
| [**PatchFirmBankAccountExternalAccountID**](BankAccountApi.md#patchfirmbankaccountexternalaccountid) | **PATCH** /api/v3/partner/firms/{firm_id}/accounts/{account_id} | Patch an external account ID for a bank account. |
...
<a name="patchfirmbankaccountexternalaccountid"></a>
# **PatchFirmBankAccountExternalAccountID**
> BankAccount PatchFirmBankAccountExternalAccountID (Guid firmId, Guid accountId, PatchFirmBankAccountExternalAccountIDRequest patchFirmBankAccountExternalAccountIDRequest)

Patch an external account ID for a bank account.

Patch an external account ID for a bank account.  Most properties of bank accounts are immutable once created, however the external account ID can be updated. nb: Successful calls to this endpoint will throw a `firm.bank-account.updated` event. 
...
namespace Example
{
    public class PatchFirmBankAccountExternalAccountIDExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            var firmId = "firmId_example";  // Guid | 
            var accountId = "accountId_example";  // Guid | 
            var patchFirmBankAccountExternalAccountIDRequest = new PatchFirmBankAccountExternalAccountIDRequest(); // PatchFirmBankAccountExternalAccountIDRequest | Bank account external account ID

            try
            {
                // Patch an external account ID for a bank account.
                BankAccount result = apiInstance.PatchFirmBankAccountExternalAccountID(firmId, accountId, patchFirmBankAccountExternalAccountIDRequest);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling BankAccountApi.PatchFirmBankAccountExternalAccountID: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
#### Using the PatchFirmBankAccountExternalAccountIDWithHttpInfo variant
This returns an ApiResponse object which contains the response data, status code and headers.
...
{
    // Patch an external account ID for a bank account.
    ApiResponse<BankAccount> response = apiInstance.PatchFirmBankAccountExternalAccountIDWithHttpInfo(firmId, accountId, patchFirmBankAccountExternalAccountIDRequest);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
...
{
    Debug.Print("Exception when calling BankAccountApi.PatchFirmBankAccountExternalAccountIDWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
| **firmId** | **Guid** |  |  |
| **accountId** | **Guid** |  |  |
| **patchFirmBankAccountExternalAccountIDRequest** | [**PatchFirmBankAccountExternalAccountIDRequest**](PatchFirmBankAccountExternalAccountIDRequest.md) | Bank account external account ID |  |
