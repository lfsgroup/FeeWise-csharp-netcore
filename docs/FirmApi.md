...
| [**PatchFirmBankAccountExternalAccountID**](FirmApi.md#patchfirmbankaccountexternalaccountid) | **PATCH** /api/v3/partner/firms/{firm_id}/accounts/{account_id} | Patch an external account ID for a bank account. |
...
namespace Example
{
    public class PatchFirmBankAccountExternalAccountIDExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling FirmApi.PatchFirmBankAccountExternalAccountID: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling FirmApi.PatchFirmBankAccountExternalAccountIDWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
